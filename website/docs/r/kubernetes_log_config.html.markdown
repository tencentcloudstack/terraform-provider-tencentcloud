...
* `log_config_name` - (Required, String, ForceNew) Log config name. Must be identical to Value `metadata.name` in Field `log_config`.
* `log_config` - (Required, String) JSON expression of log collection configuration. For more details, please refer to the guide: https://www.tencentcloud.com/zh/document/product/457/64846.
