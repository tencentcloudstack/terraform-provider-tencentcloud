...
* `realserver_certificate_id` - (Optional, **Deprecated**) It has been deprecated from version 1.27.0. Set `client_certificate_ids` instead. CA certificate ID of the realserver.
