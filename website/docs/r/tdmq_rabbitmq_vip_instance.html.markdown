...
resource "tencentcloud_tdmq_rabbitmq_vip_instance" "example" {
  ...
  time_span                             = 1
  remark                                = "This is a production instance"
...
* `enable_risk_warning` - (Optional, Bool) Whether to enable risk warning. Default is false.
...
* `remark` - (Optional, String) Remark for the RabbitMQ VIP instance.
