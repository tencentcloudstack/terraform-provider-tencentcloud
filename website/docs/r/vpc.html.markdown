...
* `assistant_cidrs` - (Optional, List) List of Assistant CIDR.
* `dns_servers` - (Optional, Set) The DNS server list of the VPC. And you can specify 0 to 5 servers to this list.
