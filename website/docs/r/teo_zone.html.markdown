...
* `plan_type` - (Optional, String) The plan option. Values:- `sta`: Standard plan that supports content delivery network outside the Chinese mainland; `ent`: Enterprise plan that supports content delivery network outside the Chinese mainland.
