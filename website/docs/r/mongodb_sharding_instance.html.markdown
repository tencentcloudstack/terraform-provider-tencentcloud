...
* `availability_zone_list` - (Optional, Set: [`String`]) A list of nodes deployed in multiple availability zones. For more information, please use the API DescribeSpecInfo.
