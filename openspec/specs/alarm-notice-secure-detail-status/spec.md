# alarm-notice-secure-detail-status Specification

## Purpose
Defines the `secure_detail_status` parameter for the `tencentcloud_cls_alarm_notice` resource, controlling the alarm detail security authentication redirect switch.
