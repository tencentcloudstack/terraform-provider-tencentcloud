# teo-confirm-multi-path-gateway-origin-acl Specification

## Purpose
TBD - created by archiving change add-teo-confirm-multi-path-gateway-origin-acl-config. Update Purpose after archive.
## Requirements
