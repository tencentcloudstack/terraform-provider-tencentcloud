# dbdc-db-custom-cluster-node-resources-datasource Specification

## Purpose
TBD - created by archiving change add-dbdc-db-custom-cluster-node-resources-datasource. Update Purpose after archive.
## Requirements
