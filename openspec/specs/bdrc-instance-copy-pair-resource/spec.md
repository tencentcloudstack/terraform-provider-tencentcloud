## Purpose
Specification for the `tencentcloud_bdrc_instance_copy_pair` resource, which manages Tencent Cloud BDRC (Backup & Disaster Recovery Center) CVM instance copy pairs.
