# tse-cloud-native-api-gateway-ip-restriction-resource Specification

## Purpose
TBD - created by archiving change add-tse-cloud-native-api-gateway-ip-restriction-resource. Update Purpose after archive.
