## Purpose
Manage the Tencent Cloud Config Aggregator (账号组) resource via `tencentcloud_config_aggregator`, supporting create, read, update, and delete operations against the config v20220802 APIs with a composite id of `account_group_id#owner_uin`.
## Requirements
