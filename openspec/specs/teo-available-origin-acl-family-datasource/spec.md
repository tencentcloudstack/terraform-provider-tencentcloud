# teo-available-origin-acl-family-datasource Specification

## Purpose
TBD - created by archiving change add-teo-available-origin-acl-family-datasource. Update Purpose after archive.
## Requirements
