## Purpose
TBD - created by archiving change add-ssl-certificate-bind-resource-task-detail-datasource. Update Purpose after archive.
## Requirements
...
- `resource_types` (List of String, Optional): 查询资源类型的结果详情，不传则查��所有。取值支持：clb、cdn、ddos、live、vod、waf、apigateway、teo、tke、cos、tse、tcb、tdmq、mqtt、gaap、scf
