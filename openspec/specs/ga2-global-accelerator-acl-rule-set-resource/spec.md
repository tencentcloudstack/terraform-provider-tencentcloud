# ga2-global-accelerator-acl-rule-set-resource Specification

## Purpose
TBD - created by archiving change add-ga2-global-accelerator-acl-rule-set-resource. Update Purpose after archive.
## Requirements
