# tke-native-node-pool-resource Specification

## Purpose

Define the specification for the `tencentcloud_kubernetes_native_node_pool` resource, covering the `custom_image` parameter within the `native` block.
