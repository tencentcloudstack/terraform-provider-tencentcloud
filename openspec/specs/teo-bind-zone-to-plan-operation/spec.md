# teo-bind-zone-to-plan-operation Specification

## Purpose
Provides a Terraform operation resource `tencentcloud_teo_bind_zone_to_plan` that calls the TEO `BindZoneToPlan` API to bind an unbound zone to an existing plan.
