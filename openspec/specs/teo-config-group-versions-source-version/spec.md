# teo-config-group-versions-source-version Specification

## Purpose
TBD - created by archiving change add-teo-config-group-versions-source-version. Update Purpose after archive.
## Requirements
