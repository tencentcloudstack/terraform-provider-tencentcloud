# teo-origin-group-health-status-datasource Specification

## Purpose
TBD - created by archiving change add-teo-origin-group-health-status-datasource. Update Purpose after archive.
## Requirements
