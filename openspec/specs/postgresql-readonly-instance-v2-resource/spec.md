# PostgreSQL Readonly Instance V2 Resource

## Purpose

This capability provides a Terraform resource (`tencentcloud_postgresql_readonly_instance_v2`) for managing Tencent Cloud PostgreSQL readonly instances, including create, read, update (immutable mode), delete (isolate), and import operations.
