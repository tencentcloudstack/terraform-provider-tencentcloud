# teo-inference-service-resource Specification

## Purpose
Defines the `tencentcloud_teo_inference_service` resource that manages a Tencent Cloud EdgeOne (TEO) inference service, including its CRUD lifecycle (Create/Read/Update/Delete), composite resource ID, retry strategy, logging conventions, documentation, unit tests, and SDK constraints.
## Requirements
