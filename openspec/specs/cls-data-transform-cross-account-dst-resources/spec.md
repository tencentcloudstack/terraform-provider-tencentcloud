# cls-data-transform-cross-account-dst-resources Specification

## Purpose
TBD - created by archiving change add-cls-data-transform-cross-account. Update Purpose after archive.
## Requirements
