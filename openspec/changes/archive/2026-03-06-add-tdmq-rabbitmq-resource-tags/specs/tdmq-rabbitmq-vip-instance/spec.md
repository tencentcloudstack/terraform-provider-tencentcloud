# Spec Delta: TDMQ RabbitMQ VIP Instance Resource Tags
...
- **GIVEN** an existing instance with `resource_tags = { "env" = "dev" }`
...
- **AND** only valid tags are added to the state map
