	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"trigger_type": {
				...
				Description: "The trigger type. Valid values:&amp;amp;lt;li&amp;amp;gt;`CosFileUpload`: The scheme is triggered when a file is uploaded to Tencent Cloud Object Storage (COS).&amp;amp;lt;/li&amp;amp;gt;&amp;amp;lt;li&amp;amp;gt;`AwsS3FileUpload`: The scheme is triggered when a file is uploaded to AWS S3.&amp;amp;lt;/li&amp;amp;gt;If you do not specify this parameter or leave it empty, all schemes will be returned regardless of the trigger type.",
			},

			"status": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "The scheme status. Valid values:&amp;amp;lt;li&amp;amp;gt;`Enabled`&amp;amp;lt;/li&amp;amp;gt;&amp;amp;lt;li&amp;amp;gt;`Disabled`&amp;amp;lt;/li&amp;amp;gt;If you do not specify this parameter, all schemes will be returned regardless of the status.",
			},
																...
																Elem: &schema.Resource{
																	Schema: map[string]*schema.Schema{
																			...
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"type": {
																						Type:        schema.TypeString,
																						Computed:    true,
																						Description: "The TSC type. Valid values:&amp;lt;li&amp;gt;`TEHD-100`: TSC-100 (video TSC). &amp;lt;/li&amp;gt;&amp;lt;li&amp;gt;`TEHD-200`: TSC-200 (audio TSC). &amp;lt;/li&amp;gt;If this parameter is left blank, no modification will be made.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																					},
																					"max_video_bitrate": {
																						Type:        schema.TypeInt,
																						Computed:    true,
																						Description: "U200dThe maximum video bitrate. If this parameter is not specified, no modifications will be made.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																					},
																				},
																			},
																		},
																		"subtitle_template": {
																			Type:        schema.TypeList,
																			Computed:    true,
																			Description: "The subtitle settings.Note: u200dThis field may return null, indicating that no valid values can be obtained.",
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"path": {
																						Type:        schema.TypeString,
																						Computed:    true,
																						Description: "The URL of the subtitles to add to the video.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																					},
																					"stream_index": {
																						Type:        schema.TypeInt,
																						Computed:    true,
																						Description: "The subtitle track to add to the video. If both `Path` and `StreamIndex` are specified, `Path` will be used. You need to specify at least one of the two parameters.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																					},
																					"font_type": {
																						Type:        schema.TypeString,
																						Computed:    true,
																						Description: "The font. Valid values:&amp;lt;li&amp;gt;`hei.ttf`: Heiti.&amp;lt;/li&amp;gt;&amp;lt;li&amp;gt;`song.ttf`: Songti.&amp;lt;/li&amp;gt;&amp;lt;li&amp;gt;`simkai.ttf`: Kaiti.&amp;lt;/li&amp;gt;&amp;lt;li&amp;gt;`arial.ttf`: Arial.&amp;lt;/li&amp;gt;The default is `hei.ttf`.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																					},
																					"font_size": {
																						Type:        schema.TypeString,
																						Computed:    true,
																						Description: "The font size (pixels). If this is not specified, the font size in the subtitle file will be used.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																					},
																					"font_color": {
																						Type:        schema.TypeString,
																						Computed:    true,
																						Description: "The font color in 0xRRGGBB format. Default value: 0xFFFFFF (white).Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																					},
																					"font_alpha": {
																						Type:        schema.TypeFloat,
																						Computed:    true,
																						Description: "The text transparency. Value range: 0-1.&amp;lt;li&amp;gt;`0`: Fully transparent.&amp;lt;/li&amp;gt;&amp;lt;li&amp;gt;`1`: u200dFully opaque.&amp;lt;/li&amp;gt;Default value: 1.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																					},
																				},
																			},
																		},
																		...
																		"std_ext_info": {
																			Type:        schema.TypeString,
																			Computed:    true,
																			Description: "An extended field for transcoding.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																		},
																		"add_on_subtitles": {
																			Type:        schema.TypeList,
																			Computed:    true,
																			Description: "The subtitle file to add.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"type": {
																						Type:        schema.TypeString,
																						Computed:    true,
																						Description: "The mode. Valid values:&amp;lt;li&amp;gt;`subtitle-stream`: Add a subtitle track.&amp;lt;/li&amp;gt;&amp;lt;li&amp;gt;`close-caption-708`: u200dEmbed EA-708 subtitles in SEI frames.&amp;lt;/li&amp;gt;&amp;lt;li&amp;gt;`close-caption-608`: Embed CEA-608 subtitles in SEI frames.&amp;lt;/li&amp;gt;Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																					},
																					"subtitle": {
																						Type:        schema.TypeList,
																						Computed:    true,
																						Description: "The subtitle file.Note: u200dThis field may returnu200d·nullu200d, indicating that no valid values can be obtained.",
																						Elem: &schema.Resource{
																							Schema: map[string]*schema.Schema{
																								"type": {
																									Type:        schema.TypeString,
...
func dataSourceTencentCloudMpsSchedulesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("schedule_ids"); ok {
		...
		for i := range scheduleIdsSet {
			...
			paramMap["ScheduleIds"] = append(paramMap["ScheduleIds"], helper.IntInt64(scheduleIds))
		}
	}
	...
	if scheduleInfoSet != nil {
		for _, schedulesInfo := range scheduleInfoSet {
				...
				if schedulesInfo.Trigger.AwsS3FileUploadTrigger != nil {
					...
					if schedulesInfo.Trigger.AwsS3FileUploadTrigger.AwsSQS != nil {
						...
						if schedulesInfo.Trigger.AwsS3FileUploadTrigger.AwsSQS.SQSRegion != nil {
							awsSQSMap["s_q_s_region"] = schedulesInfo.Trigger.AwsS3FileUploadTrigger.AwsSQS.SQSRegion
						}

						if schedulesInfo.Trigger.AwsS3FileUploadTrigger.AwsSQS.SQSQueueName != nil {
							awsSQSMap["s_q_s_queue_name"] = schedulesInfo.Trigger.AwsS3FileUploadTrigger.AwsSQS.SQSQueueName
						}
			...
			if schedulesInfo.Activities != nil {
				...
				for _, activities := range schedulesInfo.Activities {
					...
					if activities.ActivityPara != nil {
						...
						if activities.ActivityPara.SnapshotByTimeOffsetTask != nil {
							...
							if activities.ActivityPara.SnapshotByTimeOffsetTask.TimeOffsetSet != nil {
								snapshotByTimeOffsetTaskMap["time_offset_set"] = activities.ActivityPara.SnapshotByTimeOffsetTask.TimeOffsetSet
							}
				...
				schedulesInfoMap["activities"] = []interface{}{activitiesList}
			}
			...
			if schedulesInfo.TaskNotifyConfig != nil {
				...
				if schedulesInfo.TaskNotifyConfig.AwsSQS != nil {
					...
					if schedulesInfo.TaskNotifyConfig.AwsSQS.SQSRegion != nil {
						awsSQSMap["s_q_s_region"] = schedulesInfo.TaskNotifyConfig.AwsSQS.SQSRegion
					}

					if schedulesInfo.TaskNotifyConfig.AwsSQS.SQSQueueName != nil {
						awsSQSMap["s_q_s_queue_name"] = schedulesInfo.TaskNotifyConfig.AwsSQS.SQSQueueName
					}
			...
			ids = append(ids, *schedulesInfo.ScheduleId)
