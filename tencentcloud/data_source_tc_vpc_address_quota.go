...
func dataSourceTencentCloudVpcAddressQuota() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudVpcAddressQuotaRead,
...
func dataSourceTencentCloudVpcAddressQuotaRead(d *schema.ResourceData, meta interface{}) error {
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeVpcAddressQuotaByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		quotaSet = result
