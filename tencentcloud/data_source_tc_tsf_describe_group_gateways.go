/*
Use this data source to query detailed information of tsf describe_group_gateways
...
func dataSourceTencentCloudTsfDescribeGroupGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudTsfDescribeGroupGatewaysRead,
...
func dataSourceTencentCloudTsfDescribeGroupGatewaysRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_tsf_describe_group_gateways.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeTsfDescribeGroupGatewaysByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		result = result
