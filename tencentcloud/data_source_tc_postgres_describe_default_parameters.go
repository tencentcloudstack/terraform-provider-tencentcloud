/*
Use this data source to query detailed information of postgres describe_default_parameters
...
func dataSourceTencentCloudPostgresDescribeDefaultParameters() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudPostgresDescribeDefaultParametersRead,
...
func dataSourceTencentCloudPostgresDescribeDefaultParametersRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_postgres_describe_default_parameters.read")()
	...
	var paramInfoSet []*postgres.ParamInfo

	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribePostgresDescribeDefaultParametersByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		paramInfoSet = result
