/*
Use this data source to query detailed information of monitor plugin_overviews
...
func dataSourceTencentCloudMonitorPluginOverviews() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudMonitorPluginOverviewsRead,
...
func dataSourceTencentCloudMonitorPluginOverviewsRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_monitor_plugin_overviews.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeMonitorPluginOverviewsByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		pluginSet = result
