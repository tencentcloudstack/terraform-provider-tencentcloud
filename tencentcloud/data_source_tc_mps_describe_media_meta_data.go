/*
Use this data source to query detailed information of mps describe_media_meta_data
...
func dataSourceTencentCloudMpsDescribeMediaMetaData() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudMpsDescribeMediaMetaDataRead,
...
func dataSourceTencentCloudMpsDescribeMediaMetaDataRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_mps_describe_media_meta_data.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeMpsDescribeMediaMetaDataByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		metaData = result
	...
	if metaData != nil {
		...
		if metaData.VideoStreamSet != nil {
			...
			mediaMetaDataMap["video_stream_set"] = []interface{}{videoStreamSetList}
		}
		...
		if metaData.AudioStreamSet != nil {
			...
			mediaMetaDataMap["audio_stream_set"] = []interface{}{audioStreamSetList}
		}
		...
		ids = append(ids, *metaData.InputInfo)
		_ = d.Set("meta_data", mediaMetaDataMap)
	}
