/*
Use this data source to query detailed information of autoscaling last_activity
...
func dataSourceTencentCloudAutoscalingLastActivity() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudAutoscalingLastActivityRead,
...
func dataSourceTencentCloudAutoscalingLastActivityRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_autoscaling_last_activity.read")()
	...
	var activitySet []*autoscaling.Activity

	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeAutoscalingLastActivityByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		activitySet = result
	...
	if activitySet != nil {
		for _, activity := range activitySet {
			...
			if activity.ActivityRelatedInstanceSet != nil {
				...
				activityMap["activity_related_instance_set"] = []interface{}{activityRelatedInstanceSetList}
			}
			...
			if activity.LifecycleActionResultSet != nil {
				...
				activityMap["lifecycle_action_result_set"] = []interface{}{lifecycleActionResultSetList}
			}
			...
			if activity.DetailedStatusMessageSet != nil {
				...
				activityMap["detailed_status_message_set"] = []interface{}{detailedStatusMessageSetList}
			}
			...
			if activity.InvocationResultSet != nil {
				...
				activityMap["invocation_result_set"] = []interface{}{invocationResultSetList}
			}
