/*
Use this data source to query detailed information of cdb instance_param_record
...
func dataSourceTencentCloudCdbInstanceParamRecord() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudCdbInstanceParamRecordRead,
...
func dataSourceTencentCloudCdbInstanceParamRecordRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_cdb_instance_param_record.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeCdbInstanceParamRecordByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		totalCount = result
