...
func resourceTencentCloudAntiddosPortAclConfigCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_antiddos_port_acl_config.create")()
	...
	err := resource.Retry(writeRetryTimeout, func() *resource.RetryError {
		result, e := meta.(*TencentCloudClient).apiV3Conn.UseAntiddosClient().CreatePortAclConfig(request)
		if e != nil {
			return retryError(e)
		} else {
	...
	d.SetId(instanceId + FILED_SP + config)
...
func resourceTencentCloudAntiddosPortAclConfigRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_antiddos_port_acl_config.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudAntiddosPortAclConfigDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_antiddos_port_acl_config.delete")()
	defer inconsistentCheck(d, meta)()
