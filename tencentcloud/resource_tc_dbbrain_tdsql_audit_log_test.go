		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_dbbrain_tdsql_audit_log.my_log", "filter.0.host", "%"),
					resource.TestCheckResourceAttr("tencentcloud_dbbrain_tdsql_audit_log.my_log", "filter.0.user", "tf_test"),
				),
			},
		},
	})
