...
func resourceTencentCloudMpsScheduleCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_mps_schedule.create")()
	...
	err := resource.Retry(writeRetryTimeout, func() *resource.RetryError {
		result, e := meta.(*TencentCloudClient).apiV3Conn.UseMpsClient().CreateSchedule(request)
		if e != nil {
			return retryError(e)
		} else {
	...
	scheduleId = *response.Response.ScheduleId
...
func resourceTencentCloudMpsScheduleRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_mps_schedule.read")()
	defer inconsistentCheck(d, meta)()
	...
	if schedule.Activities != nil {
		...
		for _, activities := range schedule.Activities {
			activitiesMap := map[string]interface{}{}

			if schedule.Activities.ActivityType != nil {
				activitiesMap["activity_type"] = schedule.Activities.ActivityType
			}

			if schedule.Activities.ReardriveIndex != nil {
				activitiesMap["reardrive_index"] = schedule.Activities.ReardriveIndex
			}

			if schedule.Activities.ActivityPara != nil {
				activityParaMap := map[string]interface{}{}

				if schedule.Activities.ActivityPara.TranscodeTask != nil {
					transcodeTaskMap := map[string]interface{}{}

					if schedule.Activities.ActivityPara.TranscodeTask.Definition != nil {
						transcodeTaskMap["definition"] = schedule.Activities.ActivityPara.TranscodeTask.Definition
					}

					if schedule.Activities.ActivityPara.TranscodeTask.RawParameter != nil {
						rawParameterMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.Container != nil {
							rawParameterMap["container"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.Container
						}

						if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.RemoveVideo != nil {
							rawParameterMap["remove_video"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.RemoveVideo
						}

						if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.RemoveAudio != nil {
							rawParameterMap["remove_audio"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.RemoveAudio
						}

						if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate != nil {
							videoTemplateMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Codec != nil {
								videoTemplateMap["codec"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Codec
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Fps != nil {
								videoTemplateMap["fps"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Fps
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Bitrate != nil {
								videoTemplateMap["bitrate"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Bitrate
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.ResolutionAdaptive != nil {
								videoTemplateMap["resolution_adaptive"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.ResolutionAdaptive
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Width != nil {
								videoTemplateMap["width"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Width
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Height != nil {
								videoTemplateMap["height"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Height
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Gop != nil {
								videoTemplateMap["gop"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Gop
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.FillType != nil {
								videoTemplateMap["fill_type"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.FillType
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Vcrf != nil {
								videoTemplateMap["vcrf"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.VideoTemplate.Vcrf
							}

							rawParameterMap["video_template"] = []interface{}{videoTemplateMap}
						}

						if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.AudioTemplate != nil {
							audioTemplateMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.AudioTemplate.Codec != nil {
								audioTemplateMap["codec"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.AudioTemplate.Codec
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.AudioTemplate.Bitrate != nil {
								audioTemplateMap["bitrate"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.AudioTemplate.Bitrate
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.AudioTemplate.SampleRate != nil {
								audioTemplateMap["sample_rate"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.AudioTemplate.SampleRate
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.AudioTemplate.AudioChannel != nil {
								audioTemplateMap["audio_channel"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.AudioTemplate.AudioChannel
							}

							rawParameterMap["audio_template"] = []interface{}{audioTemplateMap}
						}

						if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.TEHDConfig != nil {
							tEHDConfigMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.TEHDConfig.Type != nil {
								tEHDConfigMap["type"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.TEHDConfig.Type
							}

							if schedule.Activities.ActivityPara.TranscodeTask.RawParameter.TEHDConfig.MaxVideoBitrate != nil {
								tEHDConfigMap["max_video_bitrate"] = schedule.Activities.ActivityPara.TranscodeTask.RawParameter.TEHDConfig.MaxVideoBitrate
							}
					...
					if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter != nil {
						overrideParameterMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.Container != nil {
							overrideParameterMap["container"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.Container
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.RemoveVideo != nil {
							overrideParameterMap["remove_video"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.RemoveVideo
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.RemoveAudio != nil {
							overrideParameterMap["remove_audio"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.RemoveAudio
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate != nil {
							videoTemplateMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Codec != nil {
								videoTemplateMap["codec"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Codec
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Fps != nil {
								videoTemplateMap["fps"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Fps
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Bitrate != nil {
								videoTemplateMap["bitrate"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Bitrate
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.ResolutionAdaptive != nil {
								videoTemplateMap["resolution_adaptive"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.ResolutionAdaptive
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Width != nil {
								videoTemplateMap["width"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Width
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Height != nil {
								videoTemplateMap["height"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Height
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Gop != nil {
								videoTemplateMap["gop"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Gop
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.FillType != nil {
								videoTemplateMap["fill_type"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.FillType
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Vcrf != nil {
								videoTemplateMap["vcrf"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.Vcrf
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.ContentAdaptStream != nil {
								videoTemplateMap["content_adapt_stream"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.VideoTemplate.ContentAdaptStream
							}

							overrideParameterMap["video_template"] = []interface{}{videoTemplateMap}
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate != nil {
							audioTemplateMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.Codec != nil {
								audioTemplateMap["codec"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.Codec
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.Bitrate != nil {
								audioTemplateMap["bitrate"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.Bitrate
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.SampleRate != nil {
								audioTemplateMap["sample_rate"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.SampleRate
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.AudioChannel != nil {
								audioTemplateMap["audio_channel"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.AudioChannel
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.StreamSelects != nil {
								audioTemplateMap["stream_selects"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AudioTemplate.StreamSelects
							}

							overrideParameterMap["audio_template"] = []interface{}{audioTemplateMap}
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.TEHDConfig != nil {
							tEHDConfigMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.TEHDConfig.Type != nil {
								tEHDConfigMap["type"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.TEHDConfig.Type
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.TEHDConfig.MaxVideoBitrate != nil {
								tEHDConfigMap["max_video_bitrate"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.TEHDConfig.MaxVideoBitrate
							}

							overrideParameterMap["t_e_h_d_config"] = []interface{}{tEHDConfigMap}
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate != nil {
							subtitleTemplateMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.Path != nil {
								subtitleTemplateMap["path"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.Path
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.StreamIndex != nil {
								subtitleTemplateMap["stream_index"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.StreamIndex
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.FontType != nil {
								subtitleTemplateMap["font_type"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.FontType
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.FontSize != nil {
								subtitleTemplateMap["font_size"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.FontSize
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.FontColor != nil {
								subtitleTemplateMap["font_color"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.FontColor
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.FontAlpha != nil {
								subtitleTemplateMap["font_alpha"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.SubtitleTemplate.FontAlpha
							}

							overrideParameterMap["subtitle_template"] = []interface{}{subtitleTemplateMap}
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AddonAudioStream != nil {
							addonAudioStreamList := []interface{}{}
							for _, addonAudioStream := range schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AddonAudioStream {
						...
						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.StdExtInfo != nil {
							overrideParameterMap["std_ext_info"] = schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.StdExtInfo
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AddOnSubtitles != nil {
							addOnSubtitlesList := []interface{}{}
							for _, addOnSubtitles := range schedule.Activities.ActivityPara.TranscodeTask.OverrideParameter.AddOnSubtitles {
					...
					if schedule.Activities.ActivityPara.TranscodeTask.WatermarkSet != nil {
						watermarkSetList := []interface{}{}
						for _, watermarkSet := range schedule.Activities.ActivityPara.TranscodeTask.WatermarkSet {
					...
					if schedule.Activities.ActivityPara.TranscodeTask.MosaicSet != nil {
						mosaicSetList := []interface{}{}
						for _, mosaicSet := range schedule.Activities.ActivityPara.TranscodeTask.MosaicSet {
					...
					if schedule.Activities.ActivityPara.TranscodeTask.StartTimeOffset != nil {
						transcodeTaskMap["start_time_offset"] = schedule.Activities.ActivityPara.TranscodeTask.StartTimeOffset
					}

					if schedule.Activities.ActivityPara.TranscodeTask.EndTimeOffset != nil {
						transcodeTaskMap["end_time_offset"] = schedule.Activities.ActivityPara.TranscodeTask.EndTimeOffset
					}

					if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage != nil {
						outputStorageMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.Type != nil {
							outputStorageMap["type"] = schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.Type
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.CosOutputStorage != nil {
							cosOutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.CosOutputStorage.Bucket != nil {
								cosOutputStorageMap["bucket"] = schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.CosOutputStorage.Bucket
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.CosOutputStorage.Region != nil {
								cosOutputStorageMap["region"] = schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.CosOutputStorage.Region
							}

							outputStorageMap["cos_output_storage"] = []interface{}{cosOutputStorageMap}
						}

						if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.S3OutputStorage != nil {
							s3OutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.S3OutputStorage.S3Bucket != nil {
								s3OutputStorageMap["s3_bucket"] = schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.S3OutputStorage.S3Bucket
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.S3OutputStorage.S3Region != nil {
								s3OutputStorageMap["s3_region"] = schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.S3OutputStorage.S3Region
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.S3OutputStorage.S3SecretId != nil {
								s3OutputStorageMap["s3_secret_id"] = schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.S3OutputStorage.S3SecretId
							}

							if schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.S3OutputStorage.S3SecretKey != nil {
								s3OutputStorageMap["s3_secret_key"] = schedule.Activities.ActivityPara.TranscodeTask.OutputStorage.S3OutputStorage.S3SecretKey
							}
					...
					if schedule.Activities.ActivityPara.TranscodeTask.OutputObjectPath != nil {
						transcodeTaskMap["output_object_path"] = schedule.Activities.ActivityPara.TranscodeTask.OutputObjectPath
					}

					if schedule.Activities.ActivityPara.TranscodeTask.SegmentObjectName != nil {
						transcodeTaskMap["segment_object_name"] = schedule.Activities.ActivityPara.TranscodeTask.SegmentObjectName
					}

					if schedule.Activities.ActivityPara.TranscodeTask.ObjectNumberFormat != nil {
						objectNumberFormatMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.TranscodeTask.ObjectNumberFormat.InitialValue != nil {
							objectNumberFormatMap["initial_value"] = schedule.Activities.ActivityPara.TranscodeTask.ObjectNumberFormat.InitialValue
						}

						if schedule.Activities.ActivityPara.TranscodeTask.ObjectNumberFormat.Increment != nil {
							objectNumberFormatMap["increment"] = schedule.Activities.ActivityPara.TranscodeTask.ObjectNumberFormat.Increment
						}

						if schedule.Activities.ActivityPara.TranscodeTask.ObjectNumberFormat.MinLength != nil {
							objectNumberFormatMap["min_length"] = schedule.Activities.ActivityPara.TranscodeTask.ObjectNumberFormat.MinLength
						}

						if schedule.Activities.ActivityPara.TranscodeTask.ObjectNumberFormat.PlaceHolder != nil {
							objectNumberFormatMap["place_holder"] = schedule.Activities.ActivityPara.TranscodeTask.ObjectNumberFormat.PlaceHolder
						}

						transcodeTaskMap["object_number_format"] = []interface{}{objectNumberFormatMap}
					}

					if schedule.Activities.ActivityPara.TranscodeTask.HeadTailParameter != nil {
						headTailParameterMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.TranscodeTask.HeadTailParameter.HeadSet != nil {
							headSetList := []interface{}{}
							for _, headSet := range schedule.Activities.ActivityPara.TranscodeTask.HeadTailParameter.HeadSet {
						...
						if schedule.Activities.ActivityPara.TranscodeTask.HeadTailParameter.TailSet != nil {
							tailSetList := []interface{}{}
							for _, tailSet := range schedule.Activities.ActivityPara.TranscodeTask.HeadTailParameter.TailSet {
				...
				if schedule.Activities.ActivityPara.AnimatedGraphicTask != nil {
					animatedGraphicTaskMap := map[string]interface{}{}

					if schedule.Activities.ActivityPara.AnimatedGraphicTask.Definition != nil {
						animatedGraphicTaskMap["definition"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.Definition
					}

					if schedule.Activities.ActivityPara.AnimatedGraphicTask.StartTimeOffset != nil {
						animatedGraphicTaskMap["start_time_offset"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.StartTimeOffset
					}

					if schedule.Activities.ActivityPara.AnimatedGraphicTask.EndTimeOffset != nil {
						animatedGraphicTaskMap["end_time_offset"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.EndTimeOffset
					}

					if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage != nil {
						outputStorageMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.Type != nil {
							outputStorageMap["type"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.Type
						}

						if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.CosOutputStorage != nil {
							cosOutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.CosOutputStorage.Bucket != nil {
								cosOutputStorageMap["bucket"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.CosOutputStorage.Bucket
							}

							if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.CosOutputStorage.Region != nil {
								cosOutputStorageMap["region"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.CosOutputStorage.Region
							}

							outputStorageMap["cos_output_storage"] = []interface{}{cosOutputStorageMap}
						}

						if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.S3OutputStorage != nil {
							s3OutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.S3OutputStorage.S3Bucket != nil {
								s3OutputStorageMap["s3_bucket"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.S3OutputStorage.S3Bucket
							}

							if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.S3OutputStorage.S3Region != nil {
								s3OutputStorageMap["s3_region"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.S3OutputStorage.S3Region
							}

							if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.S3OutputStorage.S3SecretId != nil {
								s3OutputStorageMap["s3_secret_id"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.S3OutputStorage.S3SecretId
							}

							if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.S3OutputStorage.S3SecretKey != nil {
								s3OutputStorageMap["s3_secret_key"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputStorage.S3OutputStorage.S3SecretKey
							}
					...
					if schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputObjectPath != nil {
						animatedGraphicTaskMap["output_object_path"] = schedule.Activities.ActivityPara.AnimatedGraphicTask.OutputObjectPath
					}

					activityParaMap["animated_graphic_task"] = []interface{}{animatedGraphicTaskMap}
				}

				if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask != nil {
					snapshotByTimeOffsetTaskMap := map[string]interface{}{}

					if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.Definition != nil {
						snapshotByTimeOffsetTaskMap["definition"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.Definition
					}

					if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ExtTimeOffsetSet != nil {
						snapshotByTimeOffsetTaskMap["ext_time_offset_set"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ExtTimeOffsetSet
					}

					if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.TimeOffsetSet != nil {
						snapshotByTimeOffsetTaskMap["time_offset_set"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.TimeOffsetSet
					}

					if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.WatermarkSet != nil {
						watermarkSetList := []interface{}{}
						for _, watermarkSet := range schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.WatermarkSet {
							watermarkSetMap := map[string]interface{}{}
					...
					if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage != nil {
						outputStorageMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.Type != nil {
							outputStorageMap["type"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.Type
						}

						if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.CosOutputStorage != nil {
							cosOutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.CosOutputStorage.Bucket != nil {
								cosOutputStorageMap["bucket"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.CosOutputStorage.Bucket
							}

							if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.CosOutputStorage.Region != nil {
								cosOutputStorageMap["region"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.CosOutputStorage.Region
							}

							outputStorageMap["cos_output_storage"] = []interface{}{cosOutputStorageMap}
						}

						if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.S3OutputStorage != nil {
							s3OutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.S3OutputStorage.S3Bucket != nil {
								s3OutputStorageMap["s3_bucket"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.S3OutputStorage.S3Bucket
							}

							if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.S3OutputStorage.S3Region != nil {
								s3OutputStorageMap["s3_region"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.S3OutputStorage.S3Region
							}

							if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.S3OutputStorage.S3SecretId != nil {
								s3OutputStorageMap["s3_secret_id"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.S3OutputStorage.S3SecretId
							}

							if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.S3OutputStorage.S3SecretKey != nil {
								s3OutputStorageMap["s3_secret_key"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputStorage.S3OutputStorage.S3SecretKey
							}
					...
					if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputObjectPath != nil {
						snapshotByTimeOffsetTaskMap["output_object_path"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.OutputObjectPath
					}

					if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ObjectNumberFormat != nil {
						objectNumberFormatMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ObjectNumberFormat.InitialValue != nil {
							objectNumberFormatMap["initial_value"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ObjectNumberFormat.InitialValue
						}

						if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ObjectNumberFormat.Increment != nil {
							objectNumberFormatMap["increment"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ObjectNumberFormat.Increment
						}

						if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ObjectNumberFormat.MinLength != nil {
							objectNumberFormatMap["min_length"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ObjectNumberFormat.MinLength
						}

						if schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ObjectNumberFormat.PlaceHolder != nil {
							objectNumberFormatMap["place_holder"] = schedule.Activities.ActivityPara.SnapshotByTimeOffsetTask.ObjectNumberFormat.PlaceHolder
						}
				...
				if schedule.Activities.ActivityPara.SampleSnapshotTask != nil {
					sampleSnapshotTaskMap := map[string]interface{}{}

					if schedule.Activities.ActivityPara.SampleSnapshotTask.Definition != nil {
						sampleSnapshotTaskMap["definition"] = schedule.Activities.ActivityPara.SampleSnapshotTask.Definition
					}

					if schedule.Activities.ActivityPara.SampleSnapshotTask.WatermarkSet != nil {
						watermarkSetList := []interface{}{}
						for _, watermarkSet := range schedule.Activities.ActivityPara.SampleSnapshotTask.WatermarkSet {
							watermarkSetMap := map[string]interface{}{}
					...
					if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage != nil {
						outputStorageMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.Type != nil {
							outputStorageMap["type"] = schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.Type
						}

						if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.CosOutputStorage != nil {
							cosOutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.CosOutputStorage.Bucket != nil {
								cosOutputStorageMap["bucket"] = schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.CosOutputStorage.Bucket
							}

							if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.CosOutputStorage.Region != nil {
								cosOutputStorageMap["region"] = schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.CosOutputStorage.Region
							}

							outputStorageMap["cos_output_storage"] = []interface{}{cosOutputStorageMap}
						}

						if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.S3OutputStorage != nil {
							s3OutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.S3OutputStorage.S3Bucket != nil {
								s3OutputStorageMap["s3_bucket"] = schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.S3OutputStorage.S3Bucket
							}

							if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.S3OutputStorage.S3Region != nil {
								s3OutputStorageMap["s3_region"] = schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.S3OutputStorage.S3Region
							}

							if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.S3OutputStorage.S3SecretId != nil {
								s3OutputStorageMap["s3_secret_id"] = schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.S3OutputStorage.S3SecretId
							}

							if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.S3OutputStorage.S3SecretKey != nil {
								s3OutputStorageMap["s3_secret_key"] = schedule.Activities.ActivityPara.SampleSnapshotTask.OutputStorage.S3OutputStorage.S3SecretKey
							}
					...
					if schedule.Activities.ActivityPara.SampleSnapshotTask.OutputObjectPath != nil {
						sampleSnapshotTaskMap["output_object_path"] = schedule.Activities.ActivityPara.SampleSnapshotTask.OutputObjectPath
					}

					if schedule.Activities.ActivityPara.SampleSnapshotTask.ObjectNumberFormat != nil {
						objectNumberFormatMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.SampleSnapshotTask.ObjectNumberFormat.InitialValue != nil {
							objectNumberFormatMap["initial_value"] = schedule.Activities.ActivityPara.SampleSnapshotTask.ObjectNumberFormat.InitialValue
						}

						if schedule.Activities.ActivityPara.SampleSnapshotTask.ObjectNumberFormat.Increment != nil {
							objectNumberFormatMap["increment"] = schedule.Activities.ActivityPara.SampleSnapshotTask.ObjectNumberFormat.Increment
						}

						if schedule.Activities.ActivityPara.SampleSnapshotTask.ObjectNumberFormat.MinLength != nil {
							objectNumberFormatMap["min_length"] = schedule.Activities.ActivityPara.SampleSnapshotTask.ObjectNumberFormat.MinLength
						}

						if schedule.Activities.ActivityPara.SampleSnapshotTask.ObjectNumberFormat.PlaceHolder != nil {
							objectNumberFormatMap["place_holder"] = schedule.Activities.ActivityPara.SampleSnapshotTask.ObjectNumberFormat.PlaceHolder
						}
				...
				if schedule.Activities.ActivityPara.ImageSpriteTask != nil {
					imageSpriteTaskMap := map[string]interface{}{}

					if schedule.Activities.ActivityPara.ImageSpriteTask.Definition != nil {
						imageSpriteTaskMap["definition"] = schedule.Activities.ActivityPara.ImageSpriteTask.Definition
					}

					if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage != nil {
						outputStorageMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.Type != nil {
							outputStorageMap["type"] = schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.Type
						}

						if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.CosOutputStorage != nil {
							cosOutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.CosOutputStorage.Bucket != nil {
								cosOutputStorageMap["bucket"] = schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.CosOutputStorage.Bucket
							}

							if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.CosOutputStorage.Region != nil {
								cosOutputStorageMap["region"] = schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.CosOutputStorage.Region
							}

							outputStorageMap["cos_output_storage"] = []interface{}{cosOutputStorageMap}
						}

						if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.S3OutputStorage != nil {
							s3OutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.S3OutputStorage.S3Bucket != nil {
								s3OutputStorageMap["s3_bucket"] = schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.S3OutputStorage.S3Bucket
							}

							if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.S3OutputStorage.S3Region != nil {
								s3OutputStorageMap["s3_region"] = schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.S3OutputStorage.S3Region
							}

							if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.S3OutputStorage.S3SecretId != nil {
								s3OutputStorageMap["s3_secret_id"] = schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.S3OutputStorage.S3SecretId
							}

							if schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.S3OutputStorage.S3SecretKey != nil {
								s3OutputStorageMap["s3_secret_key"] = schedule.Activities.ActivityPara.ImageSpriteTask.OutputStorage.S3OutputStorage.S3SecretKey
							}
					...
					if schedule.Activities.ActivityPara.ImageSpriteTask.OutputObjectPath != nil {
						imageSpriteTaskMap["output_object_path"] = schedule.Activities.ActivityPara.ImageSpriteTask.OutputObjectPath
					}

					if schedule.Activities.ActivityPara.ImageSpriteTask.WebVttObjectName != nil {
						imageSpriteTaskMap["web_vtt_object_name"] = schedule.Activities.ActivityPara.ImageSpriteTask.WebVttObjectName
					}

					if schedule.Activities.ActivityPara.ImageSpriteTask.ObjectNumberFormat != nil {
						objectNumberFormatMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.ImageSpriteTask.ObjectNumberFormat.InitialValue != nil {
							objectNumberFormatMap["initial_value"] = schedule.Activities.ActivityPara.ImageSpriteTask.ObjectNumberFormat.InitialValue
						}

						if schedule.Activities.ActivityPara.ImageSpriteTask.ObjectNumberFormat.Increment != nil {
							objectNumberFormatMap["increment"] = schedule.Activities.ActivityPara.ImageSpriteTask.ObjectNumberFormat.Increment
						}

						if schedule.Activities.ActivityPara.ImageSpriteTask.ObjectNumberFormat.MinLength != nil {
							objectNumberFormatMap["min_length"] = schedule.Activities.ActivityPara.ImageSpriteTask.ObjectNumberFormat.MinLength
						}

						if schedule.Activities.ActivityPara.ImageSpriteTask.ObjectNumberFormat.PlaceHolder != nil {
							objectNumberFormatMap["place_holder"] = schedule.Activities.ActivityPara.ImageSpriteTask.ObjectNumberFormat.PlaceHolder
						}
				...
				if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask != nil {
					adaptiveDynamicStreamingTaskMap := map[string]interface{}{}

					if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.Definition != nil {
						adaptiveDynamicStreamingTaskMap["definition"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.Definition
					}

					if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.WatermarkSet != nil {
						watermarkSetList := []interface{}{}
						for _, watermarkSet := range schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.WatermarkSet {
							watermarkSetMap := map[string]interface{}{}
					...
					if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage != nil {
						outputStorageMap := map[string]interface{}{}

						if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.Type != nil {
							outputStorageMap["type"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.Type
						}

						if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.CosOutputStorage != nil {
							cosOutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.CosOutputStorage.Bucket != nil {
								cosOutputStorageMap["bucket"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.CosOutputStorage.Bucket
							}

							if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.CosOutputStorage.Region != nil {
								cosOutputStorageMap["region"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.CosOutputStorage.Region
							}

							outputStorageMap["cos_output_storage"] = []interface{}{cosOutputStorageMap}
						}

						if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.S3OutputStorage != nil {
							s3OutputStorageMap := map[string]interface{}{}

							if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.S3OutputStorage.S3Bucket != nil {
								s3OutputStorageMap["s3_bucket"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.S3OutputStorage.S3Bucket
							}

							if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.S3OutputStorage.S3Region != nil {
								s3OutputStorageMap["s3_region"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.S3OutputStorage.S3Region
							}

							if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.S3OutputStorage.S3SecretId != nil {
								s3OutputStorageMap["s3_secret_id"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.S3OutputStorage.S3SecretId
							}

							if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.S3OutputStorage.S3SecretKey != nil {
								s3OutputStorageMap["s3_secret_key"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputStorage.S3OutputStorage.S3SecretKey
							}
					...
					if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputObjectPath != nil {
						adaptiveDynamicStreamingTaskMap["output_object_path"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.OutputObjectPath
					}

					if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.SubStreamObjectName != nil {
						adaptiveDynamicStreamingTaskMap["sub_stream_object_name"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.SubStreamObjectName
					}

					if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.SegmentObjectName != nil {
						adaptiveDynamicStreamingTaskMap["segment_object_name"] = schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.SegmentObjectName
					}

					if schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.AddOnSubtitles != nil {
						addOnSubtitlesList := []interface{}{}
						for _, addOnSubtitles := range schedule.Activities.ActivityPara.AdaptiveDynamicStreamingTask.AddOnSubtitles {
							addOnSubtitlesMap := map[string]interface{}{}
				...
				if schedule.Activities.ActivityPara.AiContentReviewTask != nil {
					aiContentReviewTaskMap := map[string]interface{}{}

					if schedule.Activities.ActivityPara.AiContentReviewTask.Definition != nil {
						aiContentReviewTaskMap["definition"] = schedule.Activities.ActivityPara.AiContentReviewTask.Definition
					}

					activityParaMap["ai_content_review_task"] = []interface{}{aiContentReviewTaskMap}
				}

				if schedule.Activities.ActivityPara.AiAnalysisTask != nil {
					aiAnalysisTaskMap := map[string]interface{}{}

					if schedule.Activities.ActivityPara.AiAnalysisTask.Definition != nil {
						aiAnalysisTaskMap["definition"] = schedule.Activities.ActivityPara.AiAnalysisTask.Definition
					}

					if schedule.Activities.ActivityPara.AiAnalysisTask.ExtendedParameter != nil {
						aiAnalysisTaskMap["extended_parameter"] = schedule.Activities.ActivityPara.AiAnalysisTask.ExtendedParameter
					}

					activityParaMap["ai_analysis_task"] = []interface{}{aiAnalysisTaskMap}
				}

				if schedule.Activities.ActivityPara.AiRecognitionTask != nil {
					aiRecognitionTaskMap := map[string]interface{}{}

					if schedule.Activities.ActivityPara.AiRecognitionTask.Definition != nil {
						aiRecognitionTaskMap["definition"] = schedule.Activities.ActivityPara.AiRecognitionTask.Definition
					}
...
func resourceTencentCloudMpsScheduleUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_mps_schedule.update")()
	defer inconsistentCheck(d, meta)()
	...
	err := resource.Retry(writeRetryTimeout, func() *resource.RetryError {
		result, e := meta.(*TencentCloudClient).apiV3Conn.UseMpsClient().ModifySchedule(request)
		if e != nil {
			return retryError(e)
		} else {
			log.Printf("[DEBUG]%s api[%s] success, request body [%s], response body [%s]\n", logId, request.GetAction(), request.ToJsonString(), result.ToJsonString())
...
func resourceTencentCloudMpsScheduleDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_mps_schedule.delete")()
	defer inconsistentCheck(d, meta)()
