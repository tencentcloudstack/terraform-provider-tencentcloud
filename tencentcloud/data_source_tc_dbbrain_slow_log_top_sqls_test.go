		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.tencentcloud_dbbrain_slow_log_top_sqls.test", "sort_by", "QueryTime"),
					resource.TestCheckResourceAttr("data.tencentcloud_dbbrain_slow_log_top_sqls.test", "schema_list.0.schema", "tf_ci_test"),
