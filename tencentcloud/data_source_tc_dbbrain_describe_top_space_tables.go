/*
Use this data source to query detailed information of dbbrain describe_top_space_tables
...
func dataSourceTencentCloudDbbrainDescribeTopSpaceTables() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudDbbrainDescribeTopSpaceTablesRead,
...
func dataSourceTencentCloudDbbrainDescribeTopSpaceTablesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_dbbrain_describe_top_space_tables.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeDbbrainDescribeTopSpaceTablesByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
	...
	if topSpaceTables != nil {
		for _, tableSpaceData := range topSpaceTables {
			...
			ids = append(ids, *tableSpaceData.InstanceId)
