/*
Use this data source to query detailed information of live describe_time_shift_record_detail
...
func dataSourceTencentCloudLiveDescribeTimeShiftRecordDetail() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudLiveDescribeTimeShiftRecordDetailRead,
...
func dataSourceTencentCloudLiveDescribeTimeShiftRecordDetailRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_live_describe_time_shift_record_detail.read")()
	...
	var recordList []*live.TimeShiftRecord

	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeLiveDescribeTimeShiftRecordDetailByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		recordList = result
	...
	if recordList != nil {
		for _, timeShiftRecord := range recordList {
			...
			ids = append(ids, *timeShiftRecord.Domain)
