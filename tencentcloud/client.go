...
import (
	...
	postgres "github.com/tencentcloud/tencentcloud-sdk-go-intl-en/tencentcloud/postgres/v20170312"
	...
	clb1 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/clb/v20180317"
	...
	dc1 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dc/v20180410"
	...
	scf1 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/scf/v20180416"
	...
	teo1 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/teo/v20220901"
...
func (me *TencentCloudClient) UseDcClient() *dc1.Client {
	if me.dcConn != nil {
		return me.dcConn
	}

	cpf := me.NewClientProfile(300)
	me.dcConn, _ = dc1.NewClient(me.Credential, me.Region, cpf)
...
func (me *TencentCloudClient) UseClbClient() *clb1.Client {
	if me.clbConn != nil {
		return me.clbConn
	}

	cpf := me.NewClientProfile(300)
	me.clbConn, _ = clb1.NewClient(me.Credential, me.Region, cpf)
...
func (me *TencentCloudClient) UseScfClient() *scf1.Client {
	if me.scfConn != nil {
		return me.scfConn
	}

	cpf := me.NewClientProfile(300)
	me.scfConn, _ = scf1.NewClient(me.Credential, me.Region, cpf)
...
func (me *TencentCloudClient) UseTeoClient() *teo1.Client {
	if me.teoConn != nil {
		return me.teoConn
	}

	cpf := me.NewClientProfile(300)
	me.teoConn, _ = teo1.NewClient(me.Credential, me.Region, cpf)
...
// UsePostgresClient returns postgres client for service
func (me *TencentCloudClient) UsePostgresClient() *postgres.Client {
	if me.postgresConn != nil {
		return me.postgresConn
	}

	cpf := me.NewClientProfile(300)
	cpf.Language = "zh-CN"
	me.postgresConn, _ = postgres.NewClient(me.Credential, me.Region, cpf)
	me.postgresConn.WithHttpTransport(&LogRoundTripper{})
