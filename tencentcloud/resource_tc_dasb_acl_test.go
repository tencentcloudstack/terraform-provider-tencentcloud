		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_acl.example", "name"),
					...
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_acl.example", "department_id"),
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_acl.example", "validate_from"),
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_acl.example", "validate_to"),
				),
			},
			{
