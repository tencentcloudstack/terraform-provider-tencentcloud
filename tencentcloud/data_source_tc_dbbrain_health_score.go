/*
Use this data source to query detailed information of dbbrain health_score
...
func dataSourceTencentCloudDbbrainHealthScore() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudDbbrainHealthScoreRead,
...
func dataSourceTencentCloudDbbrainHealthScoreRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_dbbrain_health_score.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeDbbrainHealthScoreByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		data = result
	...
	if data != nil {
		...
		ids = append(ids, *data.InstanceId)
