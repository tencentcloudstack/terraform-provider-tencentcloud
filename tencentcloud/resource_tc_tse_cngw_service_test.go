		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_tse_cngw_service.cngw_service", "gateway_id", defaultTseGatewayId),
...
const testAccTseCngwService = DefaultTseVar + `
...
const testAccTseCngwServiceUp = DefaultTseVar + `
