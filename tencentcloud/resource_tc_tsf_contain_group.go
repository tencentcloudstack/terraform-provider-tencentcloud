...
func resourceTencentCloudTsfContainGroupCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOkExists("instance_num"); ok {
...
func resourceTencentCloudTsfContainGroupRead(d *schema.ResourceData, meta interface{}) error {
	...
	if containGroup.ProtocolPorts != nil {
		...
		for _, protocolPorts := range containGroup.ProtocolPorts {
			...
			if containGroup.ProtocolPorts.Protocol != nil {
				protocolPortsMap["protocol"] = containGroup.ProtocolPorts.Protocol
			}

			if containGroup.ProtocolPorts.Port != nil {
				protocolPortsMap["port"] = containGroup.ProtocolPorts.Port
			}

			if containGroup.ProtocolPorts.TargetPort != nil {
				protocolPortsMap["target_port"] = containGroup.ProtocolPorts.TargetPort
			}

			if containGroup.ProtocolPorts.NodePort != nil {
				protocolPortsMap["node_port"] = containGroup.ProtocolPorts.NodePort
			}
	...
	if containGroup.Envs != nil {
		...
		for _, envs := range containGroup.Envs {
			...
			if containGroup.Envs.Name != nil {
				envsMap["name"] = containGroup.Envs.Name
			}

			if containGroup.Envs.Value != nil {
				envsMap["value"] = containGroup.Envs.Value
			}

			if containGroup.Envs.ValueFrom != nil {
				valueFromMap := map[string]interface{}{}

				if containGroup.Envs.ValueFrom.FieldRef != nil {
					fieldRefMap := map[string]interface{}{}

					if containGroup.Envs.ValueFrom.FieldRef.FieldPath != nil {
						fieldRefMap["field_path"] = containGroup.Envs.ValueFrom.FieldRef.FieldPath
					}

					valueFromMap["field_ref"] = []interface{}{fieldRefMap}
				}

				if containGroup.Envs.ValueFrom.ResourceFieldRef != nil {
					resourceFieldRefMap := map[string]interface{}{}

					if containGroup.Envs.ValueFrom.ResourceFieldRef.Resource != nil {
						resourceFieldRefMap["resource"] = containGroup.Envs.ValueFrom.ResourceFieldRef.Resource
					}
