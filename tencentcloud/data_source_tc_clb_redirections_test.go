		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.tencentcloud_clb_redirections.redirections", "redirection_list.0.rewrite_source_rule_id"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_clb_redirections.redirections", "redirection_list.0.rewrite_target_rule_id"),
				),
			},
		},
	})
...
data "tencentcloud_clb_redirections" "redirections" {
  ...
  rewrite_source_rule_id = "${tencentcloud_clb_redirection.redirection_basic.rewrite_source_rule_id}"
}
`
