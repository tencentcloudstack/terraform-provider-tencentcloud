		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_cat_task_set.task_set", "name", "demo"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("tencentcloud_cat_task_set.task_set", "id"),
					resource.TestCheckResourceAttr("tencentcloud_cat_task_set.task_set", "name", "demo_test"),
				),
			},
		},
	})
