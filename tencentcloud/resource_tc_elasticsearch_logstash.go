...
func resourceTencentCloudElasticsearchLogstashCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_elasticsearch_logstash.create")()
	...
	err := resource.Retry(writeRetryTimeout, func() *resource.RetryError {
		result, e := meta.(*TencentCloudClient).apiV3Conn.UseEsClient().CreateLogstashInstance(request)
		if e != nil {
			return retryError(e)
		} else {
...
func resourceTencentCloudElasticsearchLogstashRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_elasticsearch_logstash.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudElasticsearchLogstashUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_elasticsearch_logstash.update")()
	defer inconsistentCheck(d, meta)()
	...
	if d.HasChange("tags") {
		...
		resourceName := BuildTagResourceName("es", "logstash", tcClient.Region, d.Id())
...
func resourceTencentCloudElasticsearchLogstashDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloud_elasticsearch_logstash.delete")()
	defer inconsistentCheck(d, meta)()
	...
	conf := BuildStateChangeConf([]string{}, []string{"-99"}, 3*readRetryTimeout, time.Second, service.ElasticsearchLogstashStateRefreshFunc(d.Id(), []string{}))
