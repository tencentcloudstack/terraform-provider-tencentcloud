...
func TestAccTencentCloudMpsParseNotifyOperationResource_basic(t *testing.T) {
	t.Parallel()
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccMpsParseNotifyOperation,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("tencentcloud_mps_parse_notify_operation.operation", "id"),
					resource.TestCheckResourceAttrSet("tencentcloud_mps_parse_notify_operation.operation", "content"),
				),
			},
		},
	})
...
const testAccMpsParseNotifyOperation = `

resource "tencentcloud_mps_parse_notify_operation" "operation" {
