/*
Use this data source to query detailed information of ses list_receivers
...
func dataSourceTencentCloudSesListReceivers() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudSesListReceiversRead,
...
func dataSourceTencentCloudSesListReceiversRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_ses_list_receivers.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeSesListReceiversByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		data = result
	...
	if data != nil {
		for _, receiverData := range data {
			...
			ids = append(ids, *receiverData.ReceiverId)
