...
func (me *TagService) DescribeTagResourceTagById(ctx context.Context, tagKey string, tagValue string, resource string) (resourceTag *tag.GetResourcesResponseParams, errRet error) {
	logId := getLogId(ctx)
	...
	resourceTag = response.Response
	return
}

func (me *TagService) DeleteTagResourceTagById(ctx context.Context, tagKey string, tagValue string, resource string) (errRet error) {
	logId := getLogId(ctx)
...
func (me *TagService) DescribeTagTagById(ctx context.Context, tagKey string, tagValue string) (tag *tag.GetTagsResponseParams, errRet error) {
	logId := getLogId(ctx)
...
func (me *TagService) DeleteTagTagById(ctx context.Context, tagKey string, tagValue string) (errRet error) {
	logId := getLogId(ctx)
