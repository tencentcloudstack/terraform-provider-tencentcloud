...
resource "tencentcloud_ci_media_workflow" "media_workflow" {
  ...
  topology {
    dependencies {
      key   = "Start"
      value = "PicProcess_1687781482626"
    }
    dependencies {
      key   = "PicProcess_1687781482626"
      value = "End"
    }
    nodes {
      key = "Start"
      node {
        type = "Start"
        input {
          queue_id      = "p9fd0feca70264eb2811eaa25d2471ade"
          object_prefix = "/ci/"
          notify_config {
            url           = "https://www.arunma.cn"
            event         = "TaskFinish"
            type          = "Url"
            result_format = "JSON"
          }
        ...
        operation {
          template_id = "t1f498a2a34c0d48d1bd982f9e4eece20c"
          output {
            region = "ap-guangzhou"
            bucket = "terraform-ci-1308919341"
            object = "test1_jpg_00.jpg"
          }
        }
      }
    }
  }
  bucket_id = "terraform-ci-1308919341"
}
```
