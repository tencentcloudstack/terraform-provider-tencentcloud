		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.id", "list.0.instance_count", "1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.name", "list.0.instance_count", "1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.status", "list.0.cluster_id", defaultTdcpgClusterId),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.status", "list.0.cluster_name", defaultTdcpgClusterName),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.status", "list.0.region", defaultRegion),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.status", "list.0.zone", defaultTdcpgZone),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.status", "list.0.project_id", "0"),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.status", "list.0.instance_count", "1"),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.status", "list.0.pay_mode", defaultTdcpgPayMode),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.paymode", "list.0.cluster_id", defaultTdcpgClusterId),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.paymode", "list.0.cluster_name", defaultTdcpgClusterName),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.paymode", "list.0.region", defaultRegion),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.paymode", "list.0.zone", defaultTdcpgZone),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.paymode", "list.0.project_id", "0"),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.paymode", "list.0.instance_count", "1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.project", "list.0.cluster_id", defaultTdcpgClusterId),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.project", "list.0.cluster_name", defaultTdcpgClusterName),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.project", "list.0.region", defaultRegion),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.project", "list.0.zone", defaultTdcpgZone),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.project", "list.0.project_id", "0"),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.project", "list.0.instance_count", "1"),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_clusters.project", "list.0.pay_mode", defaultTdcpgPayMode),
				),
			},
		},
	})
