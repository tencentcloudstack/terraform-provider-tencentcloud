					...
					Schema: map[string]*schema.Schema{
						...
						"compare_func": {
                            ...
                            Logical symbols are divided into the following types:
								...
								belong_to (belong to)
								not_belong_to (do not belong to)
