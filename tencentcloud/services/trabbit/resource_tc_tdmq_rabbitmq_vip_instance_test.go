		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_tdmq_rabbitmq_vip_instance.example", "remark", "Test instance for integration testing"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("tencentcloud_tdmq_rabbitmq_vip_instance.example", "time_span"),
					tcacctest.AccStepTimeSleepDuration(1*time.Minute),
					resource.TestCheckResourceAttr("tencentcloud_tdmq_rabbitmq_vip_instance.example", "remark", "Updated remark for integration testing"),
...
resource "tencentcloud_tdmq_rabbitmq_vip_instance" "example" {
  ...
  time_span                             = 1
  remark                                = "Test instance for integration testing"
...
resource "tencentcloud_tdmq_rabbitmq_vip_instance" "example" {
  ...
  auto_renew_flag                       = true
  time_span                             = 1
  remark                                = "Updated remark for integration testing"
