...
func TestAccTencentCloudMpsMediaMetaDataDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccMpsMediaMetaDataDataSource, tcacctest.DefaultRegion),
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_mps_media_meta_data.metadata"),
					...
					resource.TestCheckResourceAttr("data.tencentcloud_mps_media_meta_data.metadata", "input_info.0.cos_input_info.0.region", tcacctest.DefaultRegion),
...
const testAccMpsMediaMetaDataDataSource = tcacctest.UserInfoData + `
