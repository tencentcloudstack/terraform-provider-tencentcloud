		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_mps_edit_media_operation.operation", "file_infos.0.input_info.0.cos_input_info.0.region", tcacctest.DefaultRegion),
...
const testAccMpsEditMediaOperation = tcacctest.UserInfoData + `
