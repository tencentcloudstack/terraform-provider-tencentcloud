		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_mps_withdraws_watermark_operation.operation", "input_info.0.cos_input_info.0.region", tcacctest.DefaultRegion),
...
const testAccMpsWithdrawsWatermarkOperation = tcacctest.UserInfoData + `
