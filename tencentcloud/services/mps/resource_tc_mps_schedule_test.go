...
import (
	...
	svcmps "github.com/tencentcloudstack/terraform-provider-tencentcloud/tencentcloud/services/mps"
)
...
func testSweepMpsSchedule(r string) error {
	...
	mpsService := svcmps.NewMpsService(cli.(tccommon.ProviderMeta).GetAPIV3Conn())
...
func TestAccTencentCloudMpsScheduleResource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccMpsSchedule, randomNum, tcacctest.DefaultRegion, tcacctest.DefaultRegion),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_mps_schedule.schedule", "trigger.0.cos_file_upload_trigger.0.region", tcacctest.DefaultRegion),
			...
			{
				Config: fmt.Sprintf(testAccMpsSchedule_update, randomNum, tcacctest.DefaultRegion, tcacctest.DefaultRegion),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("tencentcloud_mps_schedule.schedule", "id"),
