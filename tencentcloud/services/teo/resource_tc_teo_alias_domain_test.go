		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_teo_alias_domain.example", "zone_id", "zone-28569s6od5na"),
					resource.TestCheckResourceAttr("tencentcloud_teo_alias_domain.example", "alias_name", "alias.tf-test.com"),
					resource.TestCheckResourceAttr("tencentcloud_teo_alias_domain.example", "target_name", "target.tf-test.com"),
					...
					resource.TestCheckResourceAttrSet("tencentcloud_teo_alias_domain.example", "status"),
					resource.TestCheckResourceAttrSet("tencentcloud_teo_alias_domain.example", "created_on"),
				),
			},
			{
				Config: testAccTeoAliasDomainUpdate,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("tencentcloud_teo_alias_domain.example", "target_name", "target-updated.tf-test.com"),
