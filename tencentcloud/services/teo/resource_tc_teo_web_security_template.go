										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												...
												"action": {
													...
													Required:    true,
													MaxItems:    1,
													Description: "Action for custom rules. The Name parameter of SecurityAction supports: <li>`Deny`: block;</li> <li>`Monitor`: observe;</li> <li>`ReturnCustomPage`: block with customized page;</li> <li>`Redirect`: Redirect to URL;</li> <li>`BlockIP`: IP blocking;</li> <li>`JSChallenge`: JavaScript challenge;</li> <li>`ManagedChallenge`: managed challenge;</li> <li>`Allow`: Allow.</li>.",
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															"name": {
																Type:        schema.TypeString,
																...
																Elem: &schema.Resource{
																	Schema: map[string]*schema.Schema{
																		"min_delay_time": {
																			Type:        schema.TypeString,
																			Optional:    true,
																			Description: "Minimum latency response time. when configured as 0s, it means no delay for direct response. supported units: <li>s: seconds, value ranges from 0 to 5.</li>.",
																		},
																		"max_delay_time": {
																			Type:        schema.TypeString,
																			Optional:    true,
																			Description: "Maximum delayed response time. supported units: <li>s: seconds, value ranges from 5 to 10.</li>.",
																		},
																	},
																},
															},
																...
																Description: "Additional parameter when Name is Challenge.", Elem: &schema.Resource{
																	Schema: map[string]*schema.Schema{
																		"challenge_option": {
																			Type:        schema.TypeString,
																			Required:    true,
																			Description: "Safe execution challenge actions. valid values: <li> InterstitialChallenge: interstitial challenge;</li> <li> InlineChallenge: embedded challenge;</li> <li> JSChallenge: JavaScript challenge;</li> <li> ManagedChallenge: managed challenge.</li>.",
																		},
																		"interval": {
																			Type:        schema.TypeString,
																			Optional:    true,
																			Description: "Specifies the time interval for challenge repetition. this field is required when Name is InterstitialChallenge/InlineChallenge. default value is 300s. supported units: <li>s: second, value ranges from 1 to 60;</li><li>m: minute, value ranges from 1 to 60;</li><li>h: hour, value ranges from 1 to 24.</li>.",
																		},
																		"attester_id": {
																			Type:        schema.TypeString,
																			Optional:    true,
																...
																Elem: &schema.Resource{
																	Schema: map[string]*schema.Schema{
																		"duration": {
																			Type:        schema.TypeString,
																			Required:    true,
																			Description: "Penalty duration for `BlockIP`. Units: <li>`s`: second, value range 1-120;</li> <li>`m`: minute, value range 1-120;</li> <li>`h`: hour, value range 1-48.</li>.",
																		},
																	},
																},
															},
												...
												"enabled": {
													Type:        schema.TypeString,
													Required:    true,
													Description: "The custom rule status. Values: <li>`on`: enabled</li> <li>`off`: disabled</li>.",
												},
												"id": {
													Type:        schema.TypeString,
													Optional:    true,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"enabled": {
										Type:        schema.TypeString,
										Required:    true,
										Description: "The managed rule status. Values: <li>`on`: enabled, all managed rules take effect as configured;</li> <li>`off`: disabled, all managed rules do not take effect.</li>.",
									},
									"detection_only": {
										Type:        schema.TypeString,
										Required:    true,
										Description: "Evaluation mode is enabled or not, it is valid only when the `Enabled` parameter is set to `on`. Values: <li>`on`: enabled, all managed rules take effect in `observe` mode.</li> <li>off: disabled, all managed rules take effect according to the specified configuration.</li>.",
									},
									"semantic_analysis": {
										Type:        schema.TypeString,
										Optional:    true,
										Description: "Managed rule semantic analysis is enabled or not, it is valid only when the `Enabled` parameter is `on`. Values: <li>`on`: enabled, perform semantic analysis  before processing requests;</li> <li>`off`: disabled, process requests directly without semantic analysis.</li> <br/>The default value is `off`.",
									},
									"auto_update": {
										Type:        schema.TypeList,
										Optional:    true,
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"auto_update_to_latest_version": {
													Type:        schema.TypeString,
													Required:    true,
													Description: "Enable automatic update to the latest version or not. Values: <li>`on`: enabled</li> <li>`off`: disabled</li>.",
												},
												"ruleset_version": {
													Type:        schema.TypeString,
													Computed:    true,
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												...
												"sensitivity_level": {
													Type:        schema.TypeString,
													Required:    true,
													Description: "Protection level of the managed rule group. Values: <li>`loose`: lenient, only contain ultra-high risk rules, at this point, Action parameter needs configured instead of RuleActions parameter;</li> <li>`normal`: normal, contain ultra-high risk and high-risk rules, at this point,Action parameter needs configured instead of RuleActions parameter;</li> <li>`strict`: strict, contains ultra-high risk, high-risk and medium-risk rules, at this point, Action parameter needs configured instead of RuleActions parameter;</li> <li>`extreme`: super strict, contains ultra-high risk, high-risk, medium-risk and low-risk rules, at this point, Action parameter needs configured instead of RuleActions parameter;</li> <li>`custom`: custom, refined strategy, configure the RuleActions parameter for each individual rule, at this point, the Action field is invalid, use RuleActions to configure the refined strategy for each individual rule.</li>.",
												},
												"action": {
													Type:        schema.TypeList,
													Required:    true,
													MaxItems:    1,
													Description: "Action for ManagedRuleGroup. the Name parameter value of SecurityAction supports: <li>`Deny`: block and respond with a block page;</li> <li>`Monitor`: observe, do not process requests and record security events in logs;</li> <li>`Disabled`: not enabled, do not scan requests and skip this rule.</li>.",
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															"name": {
																Type:        schema.TypeString,
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"enabled": {
													Type:        schema.TypeString,
													Optional:    true,
													Description: "Whether the high-frequency scan protection rule is enabled. valid values: <li>on: enable. the high-frequency scan protection rule takes effect.</li><li>off: disable. the high-frequency scan protection rule does not take effect.</li>.",
												},
												"action": {
													Type:        schema.TypeList,
													Optional:    true,
												...
												"count_by": {
													Type:        schema.TypeString,
													Optional:    true,
													Description: "The match mode for request statistics. required when Enabled is on. valid values: <li>http.request.xff_header_ip: client ip (priority match xff header);</li><li>http.request.ip: client ip.</li>.",
												},
												"block_threshold": {
													Type:        schema.TypeInt,
													Optional:    true,
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"enabled": {
													Type:        schema.TypeString,
													Required:    true,
													Description: "Whether adaptive frequency control is enabled. valid values: <li>on: enable;</li> <li>off: disable.</li>.",
												},
												"sensitivity": {
													Type:        schema.TypeString,
													Optional:    true,
													Description: "The restriction level of adaptive frequency control. required when Enabled is on. valid values: <li>Loose: Loose</li><li>Moderate: Moderate</li><li>Strict: Strict</li>.",
												},
												"action": {
													Type:        schema.TypeList,
													Optional:    true,
													Computed:    true,
													MaxItems:    1,
													Description: "The handling method of adaptive frequency control. this field is required when Enabled is on. valid values for SecurityAction Name: <li>Monitor: observation;</li> <li>Deny: block;</li> <li>Challenge: Challenge, where ChallengeActionParameters.Name only supports JSChallenge.</li>.",
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															"name": {
																Type:        schema.TypeString,
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"enabled": {
													Type:        schema.TypeString,
													Required:    true,
													Description: "Whether intelligent client filtering is enabled. valid values: <li>on: enable;</li> <li>off: disable.</li>.",
												},
												"action": {
													Type:        schema.TypeList,
													Optional:    true,
													Computed:    true,
													MaxItems:    1,
													Description: "The handling method of intelligent client filtering. when Enabled is on, this field is required. the Name parameter of SecurityAction supports: <li>Monitor: observation;</li> <li>Deny: block;</li> <li>Challenge: Challenge, where ChallengeActionParameters.Name only supports JSChallenge.</li>.",
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															"name": {
																Type:        schema.TypeString,
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"enabled": {
													Type:        schema.TypeString,
													Required:    true,
													Description: "Whether bandwidth abuse protection (applicable to chinese mainland only) is enabled. valid values: <li>on: enabled;</li> <li>off: disabled.</li>.",
												},
												"action": {
													Type:        schema.TypeList,
													Optional:    true,
													Computed:    true,
													MaxItems:    1,
													Description: "Bandwidth abuse protection (applicable to chinese mainland) handling method. required when Enabled is on. valid values for SecurityAction Name: <li>Monitor: observe;</li> <li>Deny: block;</li> <li>Challenge: Challenge, where ChallengeActionParameters.Name only supports JSChallenge.</li>.",
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															"name": {
																Type:        schema.TypeString,
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"enabled": {
													Type:        schema.TypeString,
													Required:    true,
													Description: "Whether slow attack protection is enabled. valid values: <li>on: enabled;</li> <li>off: disabled.</li>.",
												},
												"action": {
													Type:        schema.TypeList,
													Optional:    true,
													Computed:    true,
													MaxItems:    1,
													Description: "Slow attack protection handling method. required when Enabled is on. valid values for SecurityAction Name: <li>Monitor: observation;</li> <li>Deny: block;</li>.",
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															"name": {
																Type:        schema.TypeString,
													...
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															...
															"counting_period": {
																Type:        schema.TypeString,
																Required:    true,
																Description: "Minimum body transfer rate statistical time range, valid values: <li>10s: 10 seconds;</li> <li>30s: 30 seconds;</li> <li>60s: 60 seconds;</li> <li>120s: 120 seconds.</li>.",
															},
															"enabled": {
																Type:        schema.TypeString,
																Required:    true,
																Description: "Specifies whether the minimum body transfer rate threshold is enabled. valid values: <li>on: enable;</li> <li>off: disable.</li>.",
															},
														},
													},
												},
													...
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															...
															"enabled": {
																Type:        schema.TypeString,
																Required:    true,
																Description: "Whether body transfer timeout is enabled. valid values: <li>`on`: enable</li> <li>`off`: disable</li>.",
															},
														},
													},
												},
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												...
												"counting_period": {
													Type:        schema.TypeString,
													Optional:    true,
													Description: "Specifies the time window for statistics. valid values: <li>1s: 1 second;</li><li>5s: 5 seconds;</li><li>10s: 10 seconds;</li><li>20s: 20 seconds;</li><li>30s: 30 seconds;</li><li>40s: 40 seconds;</li><li>50s: 50 seconds;</li><li>1m: 1 minute;</li><li>2m: 2 minutes;</li><li>5m: 5 minutes;</li><li>10m: 10 minutes;</li><li>1h: 1 hour.</li>.",
												},
												"action_duration": {
													Type:        schema.TypeString,
													Optional:    true,
													Description: "The duration of an Action is only supported in the following units: <li>s: seconds, value range 1-120;</li> <li>m: minutes, value range 1-120;</li> <li>h: hours, value range 1-48;</li> <li>d: days, value range 1-30.</li>.",
												},
												"action": {
													Type:        schema.TypeList,
													Optional:    true,
													Computed:    true,
													MaxItems:    1,
													Description: "Precision rate limiting handling methods. valid values: <li>Monitor: Monitor;</li> <li>Deny: block, where DenyActionParameters.Name supports Deny and ReturnCustomPage;</li> <li>Challenge: Challenge, where ChallengeActionParameters.Name supports JSChallenge and ManagedChallenge;</li> <li>Redirect: Redirect to URL;</li>.",
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															"name": {
																Type:        schema.TypeString,
												...
												"enabled": {
													Type:        schema.TypeString,
													Optional:    true,
													Description: "Whether the precise rate limiting rule is enabled. valid values: <li>on: enabled;</li> <li>off: disabled.</li>.",
												},
											},
										},
									},
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												...
												"skip_scope": {
													Type:        schema.TypeString,
													Optional:    true,
													Description: "Exception rule execution options, valid values: <li>WebSecurityModules: designate the security protection module for the exception rule.</li> <li>ManagedRules: designate the managed rule.</li>.",
												},
												"skip_option": {
													Type:        schema.TypeString,
													Optional:    true,
													Description: "Skip the specific type of request. valid values: <li>SkipOnAllRequestFields: skip all requests;</li> <li>SkipOnSpecifiedRequestFields: skip specified request fields.</li> valid only when SkipScope is ManagedRules.",
												},
												"web_security_modules_for_exception": {
													Type:        schema.TypeSet,
													Optional:    true,
													Description: "Specifies the security protection module for exception rules. valid only when SkipScope is WebSecurityModules. valid values: <li>websec-mod-managed-rules: managed rule.</li><li>websec-mod-rate-limiting: rate limit.</li><li>websec-mod-custom-rules: custom rule.</li><li>websec-mod-adaptive-control: adaptive frequency control, intelligent client filtering, slow attack protection, traffic theft protection.</li><li>websec-mod-bot: bot management.</li>.",
													Elem: &schema.Schema{
														Type: schema.TypeString,
													},
												},
												...
												"enabled": {
													Type:        schema.TypeString,
													Optional:    true,
													Description: "Whether the exception rule is enabled. valid values: <li>`on`: enable</li> <li>`off`: disable</li>.",
												},
											},
										},
									},
										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"rules": {
													...
													Optional:    true,
													Computed:    true,
													Description: "List of Bot custom Rules. when using ModifySecurityPolicy to modify Web protection configuration: <br> <li> if Rules in SecurityPolicy.BotManagement.CustomRules is not specified or parameter length of Rules is zero: clear all Bot custom rule configurations.</li> <li> if CustomRules in SecurityPolicy.BotManagement parameters is unspecified: keep existing Bot custom rule configurations and do not modify them.</li>.",
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															"id": {
																Type:        schema.TypeString,
															...
															"enabled": {
																Type:        schema.TypeString,
																Optional:    true,
																Description: "Whether the custom Bot rule is enabled. valid values: <li>on: enabled;</li><li>off: disabled.</li>.",
															},
															"priority": {
																Type:        schema.TypeInt,
																Optional:    true,
													...
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															"enabled": {
																Type:        schema.TypeString,
																Optional:    true,
																Description: "IP intelligence library (formerly client profile analysis). valid values: <li>on: enable;</li> <li>off: disable.</li>.",
															},
															"ip_reputation_group": {
																Type:        schema.TypeList,
																Optional:    true,
																...
																Elem: &schema.Resource{
																	Schema: map[string]*schema.Schema{
																		"high_risk_bot_requests_action": {
																			...
																			Computed:    true,
																			MaxItems:    1,
																			Description: "Execution action for malicious Bot requests. valid values for the Name parameter in SecurityAction: <li>Deny: block;</li> <li>Monitor: observe;</li> <li>Allow: pass;</li> <li>Challenge: Challenge, where ChallengeOption in ChallengeActionParameters supports JSChallenge and ManagedChallenge.</li>.",
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"name": {
																						Type:        schema.TypeString,
																		...
																		"likely_bot_requests_action": {
																			...
																			Computed:    true,
																			MaxItems:    1,
																			Description: "The execution action for suspected Bot requests. valid values for the Name parameter in SecurityAction: <li>Deny: block;</li> <li>Monitor: observe;</li> <li>Allow: pass;</li> <li>Challenge: Challenge, where ChallengeOption in ChallengeActionParameters supports JSChallenge and ManagedChallenge.</li>.",
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"name": {
																						Type:        schema.TypeString,
																		...
																		"verified_bot_requests_action": {
																			...
																			Computed:    true,
																			MaxItems:    1,
																			Description: "Execution action for friendly Bot request. SecurityAction Name parameter supports: <li>Deny: block;</li><li>Monitor: observe;</li><li>Allow: pass;</li><li>Challenge: Challenge, where ChallengeOption in ChallengeActionParameters supports JSChallenge and ManagedChallenge.</li>.",
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"name": {
																						Type:        schema.TypeString,
																		...
																		"human_requests_action": {
																			...
																			Computed:    true,
																			MaxItems:    1,
																			Description: "Execution action for a normal Bot request. valid values for the Name parameter in SecurityAction: <li>Allow: pass.</li>.",
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"name": {
																						Type:        schema.TypeString,
													...
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															...
															"enabled": {
																Type:        schema.TypeString,
																Optional:    true,
																Description: "Whether the rule is enabled. valid values: <li>`on`: enable</li> <li>`off`: disable</li>.",
															},
															"priority": {
																Type:        schema.TypeInt,
																Optional:    true,
																...
																Elem: &schema.Resource{
																	Schema: map[string]*schema.Schema{
																		"client_type": {
																			Type:        schema.TypeString,
																			Required:    true,
																			Description: "Client device type. valid values: <li>iOS;</li> <li>Android;</li> <li>WebView.</li>.",
																		},
																		"high_risk_min_score": {
																			Type:        schema.TypeInt,
																			Optional:    true,
																		...
																		"high_risk_request_action": {
																			...
																			Computed:    true,
																			MaxItems:    1,
																			Description: "Handling method for high-risk requests. valid values for SecurityAction Name: <li>Deny: block;</li> <li>Monitor: observation;</li> <li>Redirect: redirection;</li> <li>Challenge: Challenge.</li> default value: Monitor.",
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"name": {
																						Type:        schema.TypeString,
																		...
																		"medium_risk_request_action": {
																			...
																			Computed:    true,
																			MaxItems:    1,
																			Description: "Handling method for medium-risk requests. SecurityAction Name parameter supports: <li>Deny: block;</li> <li>Monitor: observe;</li> <li>Redirect: Redirect;</li> <li>Challenge: Challenge.</li> default value is Monitor.",
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"name": {
																						Type:        schema.TypeString,
															...
															"invalid_attestation_action": {
																...
																Computed:    true,
																MaxItems:    1,
																Description: "Handling method for failed client authentication. valid values for SecurityAction Name: <li>Deny: block;</li> <li>Monitor: observation;</li> <li>Redirect: redirection;</li> <li>Challenge: Challenge.</li> default value: Monitor.",
																Elem: &schema.Resource{
																	Schema: map[string]*schema.Schema{
																		"name": {
																			Type:        schema.TypeString,
													...
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															...
															"enabled": {
																Type:        schema.TypeString,
																Optional:    true,
																Description: "Whether browser spoofing detection is enabled. valid values: <li>on: enabled;</li><li>off: disabled.</li>.",
															},
															"condition": {
																Type:        schema.TypeString,
																Optional:    true,
																			...
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"issue_new_bot_session_cookie": {
																						Type:        schema.TypeString,
																						Optional:    true,
																						Description: "Whether to update Cookie and validate. valid values: <li>on: update Cookie and validate;</li> <li>off: verify only.</li>.",
																					},
																						...
																						Elem: &schema.Resource{
																							Schema: map[string]*schema.Schema{
																								"max_new_session_count_interval": {
																									Type:        schema.TypeString,
																									Optional:    true,
																									Description: "Time window for trigger threshold statistics. valid values: <li>5s: within 5 seconds;</li><li>10s: within 10 seconds;</li><li>15s: within 15 seconds;</li><li>30s: within 30 seconds;</li><li>60s: within 60 seconds;</li><li>5m: within 5 minutes;</li><li>10m: within 10 minutes;</li><li>30m: within 30 minutes;</li><li>60m: within 60 minutes.</li>.",
																								},
																						...
																						Elem: &schema.Resource{
																							Schema: map[string]*schema.Schema{
																								"enabled": {
																									Type:        schema.TypeString,
																									Optional:    true,
																									Description: "Specifies whether session rate and periodic feature verification are enabled. valid values: <li>on: enable</li><li>off: disable</li>.",
																								},
																			...
																			Elem: &schema.Resource{
																				Schema: map[string]*schema.Schema{
																					"crypto_challenge_intensity": {
																						Type:        schema.TypeString,
																						Optional:    true,
																						Description: "Specifies the proof-of-work strength. valid values: <li>low: low;</li><li>medium: medium;</li><li>high: high.</li>.",
																					},
																					"crypto_challenge_delay_before": {
																						Type:        schema.TypeString,
																						Optional:    true,
																						Description: "Specifies the execution mode for client behavior verification. valid values: <li>0ms: immediate execution;</li> <li>100ms: delay 100ms execution;</li> <li>200ms: delay 200ms execution;</li> <li>300ms: delay 300ms execution;</li> <li>400ms: delay 400ms execution;</li> <li>500ms: delay 500ms execution;</li> <li>600ms: delay 600ms execution;</li> <li>700ms: delay 700ms execution;</li> <li>800ms: delay 800ms execution;</li> <li>900ms: delay 900ms execution;</li> <li>1000ms: delay 1000ms execution.</li>.",
																					},
