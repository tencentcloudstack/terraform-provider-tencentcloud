	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"function_id": {
				...
				Computed:    true,
				ForceNew:    true,
				Description: "ID of the Function. If specified, the provided FunctionId will be used; otherwise, it will be automatically generated by the system.",
			},
...
func resourceTencentCloudTeoFunctionCreate(d *schema.ResourceData, meta interface{}) error {
	...
	err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
		...
		functionId = *result.Response.FunctionId
		return nil
	})
	if err != nil {
