...
func (me *TeoService) DescribeFunctionsByZoneId(ctx context.Context, zoneId string) (ret []*teo.Function, errRet error) {
	logId := tccommon.GetLogId(ctx)
	...
	for {
		...
		allFunctions = append(allFunctions, response.Response.Functions...)
