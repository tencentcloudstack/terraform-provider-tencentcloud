...
// go test -i; go test -test.run TestAccTencentCloudMariadbParameters_basic -v
func TestAccTencentCloudMariadbParameters_basic(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("tencentcloud_mariadb_parameters.parameters", "id"),
				),
			},
			{
...
const testAccMariadbParameters = testAccMariadbHourDbInstance + `
