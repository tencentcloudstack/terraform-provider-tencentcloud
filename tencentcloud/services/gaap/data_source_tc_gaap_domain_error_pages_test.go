		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_gaap_domain_error_pages.foo"),
...
`, 8081, tcacctest.DefaultGaapProxyId2)
...
`, 8082, tcacctest.DefaultGaapProxyId2)
