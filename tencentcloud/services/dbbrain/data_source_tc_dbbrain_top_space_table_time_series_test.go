...
func TestAccTencentCloudDbbrainTopSpaceTableTimeSeriesDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccDbbrainTopSpaceTableTimeSeriesDataSource, tcacctest.DefaultDbBrainInstanceId, startTime, endTime),
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID(testAccDbbrainTopSpaceTableTimeSeriesObject),
					resource.TestCheckResourceAttr(testAccDbbrainTopSpaceTableTimeSeriesObject, "instance_id", tcacctest.DefaultDbBrainInstanceId),
