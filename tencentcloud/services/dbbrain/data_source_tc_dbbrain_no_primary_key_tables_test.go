		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_dbbrain_no_primary_key_tables.no_primary_key_tables"),
...
const testAccDbbrainNoPrimaryKeyTablesDataSource = tcacctest.CommonPresetMysql + `
