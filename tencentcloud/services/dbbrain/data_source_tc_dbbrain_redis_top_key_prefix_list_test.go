		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_dbbrain_redis_top_key_prefix_list.redis_top_key_prefix_list"),
...
const testAccDbbrainRedisTopKeyPrefixListDataSource = tcacctest.CommonPresetRedis + `
