...
func resourceTencentCloudInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
		...
		result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().RunInstancesWithContext(ctx, request)
		if e != nil {
...
func resourceTencentCloudInstanceUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if needChange {
		...
		err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
			result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().ModifyInstancesAttributeWithContext(ctx, request)
			if e != nil {
				return tccommon.RetryError(e)
			} else {
				log.Printf("[DEBUG]%s api[%s] success, request body [%s], response body [%s]\n", logId, request.GetAction(), request.ToJsonString(), result.ToJsonString())
	...
	if needChange1 {
		request1 := cvm.NewModifyInstancesAttributeRequest()
		...
		err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
			result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().ModifyInstancesAttributeWithContext(ctx, request1)
			if e != nil {
				return tccommon.RetryError(e)
			} else {
	...
	if needChange2 {
		request2 := cvm.NewModifyInstancesAttributeRequest()
		...
		err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
			result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().ModifyInstancesAttributeWithContext(ctx, request2)
			if e != nil {
				return tccommon.RetryError(e)
			} else {
	...
	if needChange3 {
		request3 := cvm.NewModifyInstancesAttributeRequest()
		...
		err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
			result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().ModifyInstancesAttributeWithContext(ctx, request3)
			if e != nil {
				return tccommon.RetryError(e)
			} else {
	...
	if needChange4 {
		request4 := cvm.NewModifyInstancesProjectRequest()
		...
		err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
			result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().ModifyInstancesProjectWithContext(ctx, request4)
			if e != nil {
				return tccommon.RetryError(e)
			} else {
	...
	if needChange5 {
		request5 := cvm.NewResizeInstanceDisksRequest()

		response5 := cvm.NewResizeInstanceDisksResponse()
		...
		err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
			result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().ResizeInstanceDisksWithContext(ctx, request5)
			if e != nil {
				return tccommon.RetryError(e)
			} else {
	...
	if needChange6 {
		request6 := cvm.NewResetInstancesTypeRequest()

		response6 := cvm.NewResetInstancesTypeResponse()
		...
		err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
			result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().ResetInstancesTypeWithContext(ctx, request6)
			if e != nil {
				return tccommon.RetryError(e)
			} else {
	...
	if needChange7 {
		request7 := cvm.NewResetInstancesTypeRequest()

		response7 := cvm.NewResetInstancesTypeResponse()
		...
		err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
			result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().ResetInstancesTypeWithContext(ctx, request7)
			if e != nil {
				return tccommon.RetryError(e)
			} else {
	...
	if needChange8 {
		request8 := cvm.NewModifyInstancesVpcAttributeRequest()
		...
		err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
			result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().ModifyInstancesVpcAttributeWithContext(ctx, request8)
			if e != nil {
				return tccommon.RetryError(e)
			} else {
...
func resourceTencentCloudInstanceDelete(d *schema.ResourceData, meta interface{}) error {
	...
	var (
		...
		response = cvm.NewTerminateInstancesResponse()
	)
	...
	err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
		result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseCvmClient().TerminateInstancesWithContext(ctx, request)
		if e != nil {
			return tccommon.RetryError(e)
		} else {
			log.Printf("[DEBUG]%s api[%s] success, request body [%s], response body [%s]\n", logId, request.GetAction(), request.ToJsonString(), result.ToJsonString())
