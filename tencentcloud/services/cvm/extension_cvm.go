...
const (
	...
	CVM_PLACEMENT_GROUP_STRATEGY_SPREAD    = "SPREAD"
	CVM_PLACEMENT_GROUP_STRATEGY_PARTITION = "PARTITION"
...
var CVM_PLACEMENT_GROUP_STRATEGY = []string{
	CVM_PLACEMENT_GROUP_STRATEGY_SPREAD,
	CVM_PLACEMENT_GROUP_STRATEGY_PARTITION,
}
