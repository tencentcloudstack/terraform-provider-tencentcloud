...
func TestAccTencentCloudDayuL4RuleResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccDayuL4Rule, tcacctest.DefaultDayuBgpIp),
			...
			{
				Config: fmt.Sprintf(testAccDayuL4RuleUpdate, tcacctest.DefaultDayuBgpIp),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDayuL4RuleExists(testDayuL4RuleResourceKey),
					testAccCheckDayuL4RuleExists(testDayuL4RuleResourceKey),
					testAccCheckDayuL4RuleExists(testDayuL4RuleResourceKey),
...
func TestAccTencentCloudDayuL4RuleResource_UDP(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccDayuL4Rule_udp, tcacctest.DefaultDayuNet),
				Check: resource.ComposeTestCheckFunc(
