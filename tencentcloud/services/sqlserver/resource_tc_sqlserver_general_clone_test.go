...
const testAccSqlserverGeneralClone = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
...
const testAccSqlserverGeneralCloneUpdate = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
data "tencentcloud_availability_zones_by_product" "zones" {
  product = "sqlserver"
}
