		...
		Steps: []resource.TestStep{
			{
				...
				Check:  resource.ComposeTestCheckFunc(resource.TestCheckResourceAttrSet("tencentcloud_sqlserver_config_database_ct.example", "id")),
			},
			{
				ResourceName:      "tencentcloud_sqlserver_config_database_ct.example",
				ImportState:       true,
...
const testAccSqlserverConfigDatabaseCT = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
