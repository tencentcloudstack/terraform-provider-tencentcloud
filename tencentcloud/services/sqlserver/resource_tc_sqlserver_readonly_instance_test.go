...
const testAccReadonlySqlserverInstance string = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
...
const testAccReadonlySqlserverInstanceUpdate string = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
data "tencentcloud_availability_zones_by_product" "zones" {
  product = "sqlserver"
}
