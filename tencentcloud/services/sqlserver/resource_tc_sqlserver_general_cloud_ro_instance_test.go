...
const testAccSqlserverGeneralCloudRoInstance = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
...
const testAccSqlserverGeneralCloudRoInstanceUpdate = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
data "tencentcloud_availability_zones_by_product" "zones" {
  product = "sqlserver"
}
