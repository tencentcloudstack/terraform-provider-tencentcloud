...
const testAccSqlserverConfigBackupStrategy_daily = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
...
const testAccSqlserverConfigBackupStrategy_weekly = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
data "tencentcloud_availability_zones_by_product" "zones" {
  product = "sqlserver"
}
...
const testAccSqlserverConfigBackupStrategy_regular_months = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
data "tencentcloud_availability_zones_by_product" "zones" {
  product = "sqlserver"
}
...
const testAccSqlserverConfigBackupStrategy_regular_yearly = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
data "tencentcloud_availability_zones_by_product" "zones" {
  product = "sqlserver"
}
