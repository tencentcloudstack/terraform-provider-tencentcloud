		...
		Steps: []resource.TestStep{
			{
				...
				Check:  resource.ComposeTestCheckFunc(resource.TestCheckResourceAttrSet("tencentcloud_sqlserver_config_database_mdf.example", "id")),
			},
			{
				ResourceName:      "tencentcloud_sqlserver_config_database_mdf.example",
				ImportState:       true,
...
const testAccSqlserverConfigDatabaseMdf = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
