		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("tencentcloud_sqlserver_restart_db_instance.example", "id"),
				),
			},
			{
				ResourceName:      "tencentcloud_sqlserver_restart_db_instance.example",
				ImportState:       true,
...
const testAccSqlserverRestartDBInstance = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
