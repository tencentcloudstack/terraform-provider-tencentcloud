...
const testAccNewSqlserverInstance string = tcacctest.DefaultVpcVariable + tcacctest.DefaultSecurityGroupData + `
...
const testAccUpdateNewSqlserverInstance string = tcacctest.DefaultVpcSubnets + tcacctest.DefaultSecurityGroupData + `
data "tencentcloud_availability_zones_by_product" "zones" {
  product = "sqlserver"
}
