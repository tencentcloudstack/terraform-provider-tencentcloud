...
func datasourceTencentCloudKubernetesClusterCommonNamesRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("datasource.tencentcloud_kubernetes_cluster_common_names.read")()
	...
	d.SetId(clusterId + tccommon.FILED_SP + helper.DataResourceIdsHash(cns))
