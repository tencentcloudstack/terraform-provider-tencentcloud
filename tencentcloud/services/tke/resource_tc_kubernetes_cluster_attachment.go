...
func resourceTencentCloudKubernetesClusterAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	...
	var (
		request  = tkev20180525.NewAddExistedInstancesRequest()
		response = tkev20180525.NewAddExistedInstancesResponse()
	)
	...
	err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
		result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseTkeV20180525Client().AddExistedInstancesWithContext(ctx, request)
		if e != nil {
...
func resourceTencentCloudKubernetesClusterAttachmentRead(d *schema.ResourceData, meta interface{}) error {
	...
	var respData2 *tkev20180525.Instance
...
func resourceTencentCloudKubernetesClusterAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	...
	var (
		request  = tkev20180525.NewDeleteClusterInstancesRequest()
		response = tkev20180525.NewDeleteClusterInstancesResponse()
	)
	...
	err := resource.Retry(tccommon.WriteRetryTimeout, func() *resource.RetryError {
		result, e := meta.(tccommon.ProviderMeta).GetAPIV3Conn().UseTkeV20180525Client().DeleteClusterInstancesWithContext(ctx, request)
		if e != nil {
