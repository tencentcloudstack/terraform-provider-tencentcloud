		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_ci_media_transcode_template.media_transcode_template", "bucket", tcacctest.DefaultCiBucket),
					...
					resource.TestCheckResourceAttr("tencentcloud_ci_media_transcode_template.media_transcode_template", "audio_mix.0.audio_source", "https://"+tcacctest.DefaultCiBucket+".cos.ap-guangzhou.myqcloud.com/mp3%2Fnizhan-test.mp3"),
