		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_ci_media_concat_template.media_concat_template", "bucket", tcacctest.DefaultCiBucket),
					...
					resource.TestCheckResourceAttr("tencentcloud_ci_media_concat_template.media_concat_template", "concat_template.0.concat_fragment.0.url", "https://"+tcacctest.DefaultCiBucket+".cos.ap-guangzhou.myqcloud.com/mp4%2Fmp4-test.mp4"),
					...
					resource.TestCheckResourceAttr("tencentcloud_ci_media_concat_template.media_concat_template", "concat_template.0.concat_fragment.1.url", "https://"+tcacctest.DefaultCiBucket+".cos.ap-guangzhou.myqcloud.com/mp4%2Fmp4-test.mp4"),
					...
					resource.TestCheckResourceAttr("tencentcloud_ci_media_concat_template.media_concat_template", "concat_template.0.audio_mix.0.audio_source", "https://"+tcacctest.DefaultCiBucket+".cos.ap-guangzhou.myqcloud.com/mp3%2Fnizhan-test.mp3"),
...
resource "tencentcloud_ci_media_concat_template" "media_concat_template" {
	...
	concat_template {
		concat_fragment {
			url = "https://` + tcacctest.DefaultCiBucket + `.cos.ap-guangzhou.myqcloud.com/mp4%2Fmp4-test.mp4"
			mode = "Start"
		}
		concat_fragment {
			url = "https://` + tcacctest.DefaultCiBucket + `.cos.ap-guangzhou.myqcloud.com/mp4%2Fmp4-test.mp4"
