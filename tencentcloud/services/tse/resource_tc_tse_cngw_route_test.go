		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("tencentcloud_tse_cngw_route.cngw_route", "gateway_id", tcacctest.DefaultTseGatewayId),
...
const testAccTseCngwRoute = tcacctest.DefaultTseVar + `
...
const testAccTseCngwRouteUp = tcacctest.DefaultTseVar + `
