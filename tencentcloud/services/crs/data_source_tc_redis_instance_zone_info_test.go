		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_redis_instance_zone_info.instance_zone_info"),
...
variable "vpc_id" {
	default = "` + tcacctest.DefaultCrsVpcId + `"
}
variable "subnet_id" {
	default = "` + tcacctest.DefaultCrsSubnetId + `"
}
`
