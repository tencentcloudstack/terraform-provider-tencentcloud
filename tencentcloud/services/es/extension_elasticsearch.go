...
const (
	...
	ES_NODE_TYPE_DEDICATED_COORDINATING = "dedicatedCoordinating"
	ES_NODE_TYPE_DEDICATED_ML           = "dedicatedMl"
	...
	ES_DESTROY_PROTECTION_OPEN  = "OPEN"
	ES_DESTROY_PROTECTION_CLOSE = "CLOSE"
)
...
var ES_NODE_TYPE = []string{
	...
	ES_NODE_TYPE_DEDICATED_COORDINATING,
	ES_NODE_TYPE_DEDICATED_ML,
}
...
var ES_DESTROY_PROTECTION = []string{
	ES_DESTROY_PROTECTION_OPEN,
	ES_DESTROY_PROTECTION_CLOSE,
}

var ES_CEREBRO_PUBLIC_ACCESS = []string{
	ES_PUBLIC_ACCESS_OPEN,
	ES_PUBLIC_ACCESS_CLOSE,
}

var ES_CEREBRO_PRIVATE_ACCESS = []string{
	ES_PRIVATE_ACCESS_OPEN,
	ES_PRIVATE_ACCESS_CLOSE,
}
