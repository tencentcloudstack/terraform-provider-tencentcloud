		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_dnats.multi_dnats"),
					resource.TestCheckResourceAttr("data.tencentcloud_dnats.multi_dnats", "dnat_list.#", "1"),
					resource.TestCheckResourceAttr("data.tencentcloud_dnats.multi_dnats", "dnat_list.0.description", tcacctest.DefaultInsName),
				),
			},
		},
	})
...
const testAccTencentCloudDataSourceDnatsBase = tcacctest.InstanceCommonTestCase + `
# Create EIP 
