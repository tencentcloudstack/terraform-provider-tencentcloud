		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_enis.foo"),
					...
					resource.TestCheckResourceAttr("data.tencentcloud_enis.foo", "enis.0.state", svcvpc.ENI_STATE_AVAILABLE),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_enis.vpc"),
					...
					resource.TestCheckResourceAttr("data.tencentcloud_enis.vpc", "enis.0.state", svcvpc.ENI_STATE_AVAILABLE),
					...
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_enis.subnet"),
					...
					resource.TestCheckResourceAttr("data.tencentcloud_enis.subnet", "enis.0.state", svcvpc.ENI_STATE_AVAILABLE),
					...
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_enis.name"),
					...
					resource.TestCheckResourceAttr("data.tencentcloud_enis.name", "enis.0.state", svcvpc.ENI_STATE_AVAILABLE),
					...
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_enis.description"),
					...
					resource.TestCheckResourceAttr("data.tencentcloud_enis.description", "enis.0.state", svcvpc.ENI_STATE_AVAILABLE),
					...
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_enis.ipv4"),
					...
					resource.TestCheckResourceAttr("data.tencentcloud_enis.ipv4", "enis.0.state", svcvpc.ENI_STATE_AVAILABLE),
					...
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_enis.tags"),
					...
					resource.TestCheckResourceAttr("data.tencentcloud_enis.tags", "enis.0.state", svcvpc.ENI_STATE_AVAILABLE),
