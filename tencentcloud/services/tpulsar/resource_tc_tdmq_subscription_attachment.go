...
func resourceTencentCloudTdmqSubscriptionAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_tdmq_subscription_attachment.create")()
	...
	d.SetId(strings.Join([]string{environmentId, Topic, subscriptionName, clusterId}, tccommon.FILED_SP))
...
func resourceTencentCloudTdmqSubscriptionAttachmentRead(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_tdmq_subscription_attachment.read")()
	defer tccommon.InconsistentCheck(d, meta)()
...
func resourceTencentCloudTdmqSubscriptionAttachmentUpdate(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_tdmq_subscription_attachment.update")()
	defer tccommon.InconsistentCheck(d, meta)()
...
func resourceTencentCloudTdmqSubscriptionAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	defer tccommon.LogElapsed("resource.tencentcloud_tdmq_subscription_attachment.delete")()
	defer tccommon.InconsistentCheck(d, meta)()
