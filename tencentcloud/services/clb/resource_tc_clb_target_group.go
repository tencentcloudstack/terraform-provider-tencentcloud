	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"snat_enable": {
				...
				Optional:    true,
				Computed:    true,
				Description: "Whether to enable SNAT (Source Network Address Translation) for the target group. true: enable, false: disable. Whether SNAT actually takes effect depends on the target group type (v1/v2) and protocol; the cloud side determines applicability.",
			},
		},
	}
}
