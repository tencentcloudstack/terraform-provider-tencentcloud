...
var CLB_LISTENER_HEALTH_CHECK_TYPE_TCP = []string{
	HEALTH_CHECK_TYPE_TCP,
	HEALTH_CHECK_TYPE_HTTP,
	HEALTH_CHECK_TYPE_CUSTOM,
}
var CLB_LISTENER_HEALTH_CHECK_TYPE_UDP = []string{
	HEALTH_CHECK_TYPE_PING,
	HEALTH_CHECK_TYPE_CUSTOM,
}
var CLB_LISTENER_HEALTH_CHECK_TYPE_PROTOCOL = map[string][]string{
	CLB_LISTENER_PROTOCOL_TCP: CLB_LISTENER_HEALTH_CHECK_TYPE_TCP,
	CLB_LISTENER_PROTOCOL_UDP: CLB_LISTENER_HEALTH_CHECK_TYPE_UDP,
}
