...
func TestAccTencentCloudGwlbInstanceAssociateTargetGroupsResource_basic(t *testing.T) {
	t.Parallel()
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccGwlbInstanceAssociateTargetGroups,
				Check:  resource.ComposeTestCheckFunc(resource.TestCheckResourceAttrSet("tencentcloud_gwlb_instance_associate_target_groups.gwlb_instance_associate_target_groups", "id")),
			},
		},
	})
}

const testAccGwlbInstanceAssociateTargetGroups = `
