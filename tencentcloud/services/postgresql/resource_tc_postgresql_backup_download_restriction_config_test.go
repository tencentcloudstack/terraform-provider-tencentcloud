...
const testAccPostgresqlBackupDownloadRestrictionConfig_CUSTOMIZE_ALLOW = tcacctest.DefaultVpcVariable + `
...
const testAccPostgresqlBackupDownloadRestrictionConfig_CUSTOMIZE_DENY = tcacctest.DefaultVpcVariable + `
resource "tencentcloud_vpc" "pg_vpc1" {
	name       = var.instance_name
	cidr_block = var.vpc_cidr
}
