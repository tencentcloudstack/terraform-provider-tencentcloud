		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_postgresql_default_parameters.default_parameters"),
...
const testAccPostgresqlDefaultParametersDataSource = tcacctest.CommonPresetPGSQL + `
