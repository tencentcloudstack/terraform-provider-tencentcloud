		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID("data.tencentcloud_postgresql_backup_download_urls.backup_download_urls"),
...
const testAccPostgresqlBackupDownloadUrlsDataSource = tcacctest.OperationPresetPGSQL + tcacctest.DefaultVpcSubnets + `
