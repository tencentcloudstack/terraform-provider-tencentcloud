		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					tcacctest.AccCheckTencentCloudDataSourceID(testAccPostgresqlReadonlyGroupsObject),
...
const testAccPostgresqlReadonlyGroupsDataSource = tcacctest.CommonPresetPGSQL + `
