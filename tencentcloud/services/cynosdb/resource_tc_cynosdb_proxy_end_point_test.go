...
const testAccCynosdbProxyEndPoint = tcacctest.CommonCynosdb + tcacctest.DefaultCrsVar + `
...
const testAccCynosdbProxyEndPointUpdate = tcacctest.CommonCynosdb + tcacctest.DefaultCrsVar + `
resource "tencentcloud_cynosdb_proxy" "proxy" {
  cluster_id               = var.cynosdb_cluster_id
  cpu                      = 2
  mem                      = 4000
