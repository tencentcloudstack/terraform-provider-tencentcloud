/*
Use this data source to query detailed information of ses list_black_email_address
...
func dataSourceTencentCloudSesListBlackEmailAddress() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudSesListBlackEmailAddressRead,
...
func dataSourceTencentCloudSesListBlackEmailAddressRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_ses_list_black_email_address.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeSesListBlackEmailAddressByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		blackList = result
