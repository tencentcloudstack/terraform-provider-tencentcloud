		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					//resource.TestCheckResourceAttr(testDataDayuDdosPolicyCasesName, "list.0.platform_types.0", "PC"),
					...
					//resource.TestCheckResourceAttr(testDataDayuDdosPolicyCasesName, "list.0.app_protocols.0", "tcp"),
