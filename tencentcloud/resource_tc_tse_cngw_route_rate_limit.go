...
```
terraform import tencentcloud_tse_cngw_route_rate_limit.cngw_route_rate_limit cngw_route_rate_limit_id
```
*/
...
func resourceTencentCloudTseCngwRouteRateLimitCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if tags := helper.GetTags(d, "tags"); len(tags) > 0 {
		...
		resourceName := fmt.Sprintf("qcs::tse:%s:uin/:cngw_route_limit/%s", region, d.Id())
...
func resourceTencentCloudTseCngwRouteRateLimitRead(d *schema.ResourceData, meta interface{}) error {
	...
	tags, err := tagService.DescribeResourceTags(ctx, "tse", "cngw_route_limit", tcClient.Region, d.Id())
	if err != nil {
		return err
	}
	_ = d.Set("tags", tags)
...
func resourceTencentCloudTseCngwRouteRateLimitUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("tags") {
		...
		resourceName := BuildTagResourceName("tse", "cngw_route_limit", tcClient.Region, d.Id())
