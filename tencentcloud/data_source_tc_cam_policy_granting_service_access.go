	...
	if list != nil {
		for _, listGrantServiceAccessNode := range list {
			...
			if listGrantServiceAccessNode.Action != nil {
				...
				listGrantServiceAccessNodeMap["action"] = []interface{}{actionList}
			}
			...
			if listGrantServiceAccessNode.Policy != nil {
				...
				listGrantServiceAccessNodeMap["policy"] = []interface{}{policyList}
			}

			ids = append(ids, *listGrantServiceAccessNode.TargetUin)
