/*
Use this data source to query detailed information of tsf describe_public_config_summary
...
func dataSourceTencentCloudTsfDescribePublicConfigSummary() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudTsfDescribePublicConfigSummaryRead,
...
func dataSourceTencentCloudTsfDescribePublicConfigSummaryRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_tsf_describe_public_config_summary.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeTsfDescribePublicConfigSummaryByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		result = result
