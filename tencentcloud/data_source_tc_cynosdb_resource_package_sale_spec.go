/*
Use this data source to query detailed information of cynosdb resource_package_sale_spec
...
func dataSourceTencentCloudCynosdbResourcePackageSaleSpec() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudCynosdbResourcePackageSaleSpecRead,
...
func dataSourceTencentCloudCynosdbResourcePackageSaleSpecRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_cynosdb_resource_package_sale_spec.read")()
	...
	var detail []*cynosdb.SalePackageSpec

	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeCynosdbResourcePackageSaleSpecByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		detail = result
	...
	if detail != nil {
		for _, salePackageSpec := range detail {
			...
			ids = append(ids, *salePackageSpec.MinPackageSpec)
