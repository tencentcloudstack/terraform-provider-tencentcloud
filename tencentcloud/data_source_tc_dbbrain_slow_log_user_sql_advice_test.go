		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.tencentcloud_dbbrain_slow_log_user_sql_advice.test", "sql_text", ""),
					...
					resource.TestCheckResourceAttrSet("data.tencentcloud_dbbrain_slow_log_user_sql_advice.test", "cost"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dbbrain_slow_log_user_sql_advice.test", "request_id"),
				),
			},
		},
	})
