/*
Use this data source to query detailed information of postgres regions
...
func dataSourceTencentCloudPostgresRegions() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudPostgresRegionsRead,
...
func dataSourceTencentCloudPostgresRegionsRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_postgres_regions.read")()
	...
	var regionSet []*postgres.RegionInfo

	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribePostgresRegionsByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		regionSet = result
