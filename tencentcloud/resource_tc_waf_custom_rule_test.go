...
// go test -i; go test -test.run TestAccTencentCloudNeedFixWafCustomRuleResource_basic -v
func TestAccTencentCloudNeedFixWafCustomRuleResource_basic(t *testing.T) {
	t.Parallel()
