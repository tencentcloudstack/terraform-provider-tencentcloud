/*
Use this data source to query detailed information of live backup_stream
...
func dataSourceTencentCloudLiveBackupStream() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudLiveBackupStreamRead,
...
func dataSourceTencentCloudLiveBackupStreamRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_live_backup_stream.read")()
	...
	var streamInfoList []*live.BackupStreamGroupInfo

	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeLiveBackupStreamByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
	...
	if streamInfoList != nil {
		for _, backupStreamGroupInfo := range streamInfoList {
			...
			if backupStreamGroupInfo.BackupList != nil {
				...
				backupStreamGroupInfoMap["backup_list"] = []interface{}{backupListList}
			}
