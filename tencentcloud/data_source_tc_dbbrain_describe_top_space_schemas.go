/*
Use this data source to query detailed information of dbbrain describe_top_space_schemas
...
func dataSourceTencentCloudDbbrainDescribeTopSpaceSchemas() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudDbbrainDescribeTopSpaceSchemasRead,
...
func dataSourceTencentCloudDbbrainDescribeTopSpaceSchemasRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_dbbrain_describe_top_space_schemas.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeDbbrainDescribeTopSpaceSchemasByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
	...
	if topSpaceSchemas != nil {
		for _, schemaSpaceData := range topSpaceSchemas {
			...
			ids = append(ids, *schemaSpaceData.InstanceId)
