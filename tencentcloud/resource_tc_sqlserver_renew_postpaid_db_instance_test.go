		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("tencentcloud_sqlserver_renew_postpaid_db_instance.renew_postpaid_db_instance", "id"),
				),
			},
			{
				ResourceName:      "tencentcloud_sqlserver_renew_postpaid_db_instance.renew_postpaid_db_instance",
				ImportState:       true,
...
const testAccSqlserverRenewPostpaidDBInstance = testAccSqlserverBasicInstanceNetwork + `
