/*
Use this data source to query detailed information of tsf description_container_group
...
func dataSourceTencentCloudTsfDescriptionContainerGroup() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudTsfDescriptionContainerGroupRead,
...
func dataSourceTencentCloudTsfDescriptionContainerGroupRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_tsf_description_container_group.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeTsfDescriptionContainerGroupByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		result = result
