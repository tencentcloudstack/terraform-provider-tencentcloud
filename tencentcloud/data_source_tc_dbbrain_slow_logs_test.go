...
func TestAccTencentCloudDbbrainSlowLogsDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccDbbrainSlowLogsDataSource, defaultDbBrainInstanceId, startTime, endTime),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTencentCloudDataSourceID("data.tencentcloud_dbbrain_slow_logs.slow_logs"),
					resource.TestCheckResourceAttr("data.tencentcloud_dbbrain_slow_logs.slow_logs", "instance_id", defaultDbBrainInstanceId),
