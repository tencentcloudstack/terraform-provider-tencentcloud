/*
Use this data source to query detailed information of live describe_live_x_p2_p_detail_info_list
...
func dataSourceTencentCloudLiveDescribeLiveXP2PDetailInfoList() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudLiveDescribeLiveXP2PDetailInfoListRead,
...
func dataSourceTencentCloudLiveDescribeLiveXP2PDetailInfoListRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_live_describe_live_x_p2_p_detail_info_list.read")()
	...
	var dataInfoList []*live.XP2PDetailInfo

	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeLiveDescribeLiveXP2PDetailInfoListByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		dataInfoList = result
