...
func (me *WedataService) DescribeWedataDatasouce_DescribeDataSourceListByFilter(ctx context.Context, param map[string]interface{}) (datasouce_DescribeDataSourceList []*wedata.DataSourceInfoPage, errRet error) {
	var (
		logId   = getLogId(ctx)
		request = wedata.NewDescribeDataSourceListRequest()
	)
	...
	for {
		...
		datasouce_DescribeDataSourceList = append(datasouce_DescribeDataSourceList, response.Response.Data...)
...
func (me *WedataService) DescribeWedataDatasouce_DescribeDataSourceWithoutInfoByFilter(ctx context.Context, param map[string]interface{}) (datasouce_DescribeDataSourceWithoutInfo []*wedata.DataSourceInfo, errRet error) {
	var (
		logId   = getLogId(ctx)
		request = wedata.NewDescribeDataSourceWithoutInfoRequest()
	)
	...
	for {
		...
		datasouce_DescribeDataSourceWithoutInfo = append(datasouce_DescribeDataSourceWithoutInfo, response.Response.Data...)
		if len(response.Response.Data) < int(limit) {
			break
		}
...
func (me *WedataService) DescribeWedataDq_ruleById(ctx context.Context, ruleId string) (dq_rule *wedata.Rule, errRet error) {
	logId := getLogId(ctx)
	...
	if len(response.Response.Rule) < 1 {
		return
	}

	dq_rule = response.Response.Rule[0]
	return
}

func (me *WedataService) DeleteWedataDq_ruleById(ctx context.Context, ruleId string) (errRet error) {
	logId := getLogId(ctx)
...
func (me *WedataService) DescribeWedataDq_ruleTemplateById(ctx context.Context, templateId string) (dq_ruleTemplate *wedata.RuleTemplate, errRet error) {
	logId := getLogId(ctx)
	...
	if len(response.Response.RuleTemplate) < 1 {
		return
	}

	dq_ruleTemplate = response.Response.RuleTemplate[0]
	return
}

func (me *WedataService) DeleteWedataDq_ruleTemplateById(ctx context.Context, templateId string) (errRet error) {
	logId := getLogId(ctx)
...
func (me *WedataService) DescribeWedataBaseline_baselineById(ctx context.Context, baselineId string) (baseline_baseline *wedata.BaselineDetailResponse, errRet error) {
	logId := getLogId(ctx)
	...
	if len(response.Response.BaselineDetailResponse) < 1 {
		return
	}

	baseline_baseline = response.Response.BaselineDetailResponse[0]
	return
}

func (me *WedataService) DeleteWedataBaseline_baselineById(ctx context.Context, baselineId string) (errRet error) {
	logId := getLogId(ctx)
...
func (me *WedataService) DescribeWedataIntegration_offline_taskById(ctx context.Context, taskId string) (integration_offline_task *wedata.IntegrationTaskInfo, errRet error) {
	logId := getLogId(ctx)
	...
	if len(response.Response.IntegrationTaskInfo) < 1 {
		return
	}

	integration_offline_task = response.Response.IntegrationTaskInfo[0]
	return
}

func (me *WedataService) DeleteWedataIntegration_offline_taskById(ctx context.Context, taskId string) (errRet error) {
	logId := getLogId(ctx)
...
func (me *WedataService) DescribeWedataIntegration_real_time_taskById(ctx context.Context, taskId string) (integration_real_time_task *wedata.IntegrationTaskInfo, errRet error) {
	logId := getLogId(ctx)
	...
	integration_real_time_task = response.Response.IntegrationTaskInfo[0]
	return
}

func (me *WedataService) DeleteWedataIntegration_real_time_taskById(ctx context.Context, taskId string) (errRet error) {
	logId := getLogId(ctx)
...
func (me *WedataService) DescribeWedataIntegration_task_nodeById(ctx context.Context, id string) (integration_task_node *wedata.IntegrationNodeInfo, errRet error) {
	logId := getLogId(ctx)
	...
	if len(response.Response.IntegrationNodeInfo) < 1 {
		return
	}

	integration_task_node = response.Response.IntegrationNodeInfo[0]
	return
}

func (me *WedataService) DeleteWedataIntegration_task_nodeById(ctx context.Context, id string) (errRet error) {
	logId := getLogId(ctx)
