	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"client_token": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "A string used to guarantee the idempotency of the request. The string is generated by the customer and is guaranteed to be unique between requests, with a maximum value of no more than 64 ASCII characters. If this parameter is not specified, the requested idempotency is not guaranteed.",
			},
...
func resourceTencentCloudReservedInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("client_token"); ok {
		extendParams["client_token"] = v.(string)
	}
