		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.tencentcloud_dbbrain_diag_db_instances.diag_db_instances", "items.0.instance_conf.0.is_supported"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dbbrain_diag_db_instances.diag_db_instances", "items.0.instance_conf.0.deadline_time"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dbbrain_diag_db_instances.diag_db_instances", "items.0.instance_conf.0.sec_audit_status"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dbbrain_diag_db_instances.diag_db_instances", "items.0.instance_conf.0.audit_policy_status"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dbbrain_diag_db_instances.diag_db_instances", "items.0.instance_conf.0.audit_running_status"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dbbrain_diag_db_instances.diag_db_instances", "items.0.instance_conf.0.create_time"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dbbrain_diag_db_instances.diag_db_instances", "db_scan_status"),
				),
			},
		},
	})
