/*
Use this data source to query detailed information of tsf describe_group_instances
...
func dataSourceTencentCloudTsfDescribeGroupInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudTsfDescribeGroupInstancesRead,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"lan_ip": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Machine&amp;#39;s private IP address.Note: This field may return null, which means no valid value was found.",
									},
									"wan_ip": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Machine&amp;#39;s public IP address.Note: This field may return null, which means no valid value was found.",
									},
									"instance_desc": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Machine&amp;#39;s description.Note: This field may return null, which means no valid value was found.",
									},
									"cluster_id": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Machine&amp;#39;s cluster id.Note: This field may return null, which means no valid value was found.",
									},
									"cluster_name": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Machine&amp;#39;s cluster name .Note: This field may return null, which means no valid value was found.",
									},
									"instance_status": {
										Type:        schema.TypeString,
										Computed:    true,
									...
									"group_id": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Machine&amp;#39;s group id.Note: This field may return null, which means no valid value was found.",
									},
									"application_id": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Machine&amp;#39;s application id.Note: This field may return null, which means no valid value was found.",
									},
									"application_name": {
										Type:        schema.TypeString,
										Computed:    true,
										Description: "Machine&amp;#39;s application name .Note: This field may return null, which means no valid value was found.",
									},
...
func dataSourceTencentCloudTsfDescribeGroupInstancesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_tsf_describe_group_instances.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeTsfDescribeGroupInstancesByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		result = result
	...
	if result != nil {
		...
		if result.Content != nil {
			...
			tsfPageInstanceMap["content"] = []interface{}{contentList}
		}

		ids = append(ids, *result.GroupId)
		_ = d.Set("result", tsfPageInstanceMap)
	}
