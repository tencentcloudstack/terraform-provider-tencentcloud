		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "error_codes", "", "404"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "error_codes", "", "503"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGaapDomainErrorPageExists("tencentcloud_gaap_domain_error_page.foo", listenerId, domain, id),
					resource.TestCheckResourceAttrSet("tencentcloud_gaap_domain_error_page.foo", "listener_id"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "error_codes", "", "400"),
					resource.TestCheckResourceAttr("tencentcloud_gaap_domain_error_page.foo", "body", "bad request"),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGaapDomainErrorPageExists("tencentcloud_gaap_domain_error_page.foo", listenerId, domain, id),
					resource.TestCheckResourceAttrSet("tencentcloud_gaap_domain_error_page.foo", "listener_id"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "error_codes", "", "402"),
					resource.TestCheckResourceAttr("tencentcloud_gaap_domain_error_page.foo", "body", "bad request"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGaapDomainErrorPageExists("tencentcloud_gaap_domain_error_page.foo", listenerId, domain, id),
					resource.TestCheckResourceAttrSet("tencentcloud_gaap_domain_error_page.foo", "listener_id"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "error_codes", "", "403"),
					resource.TestCheckResourceAttr("tencentcloud_gaap_domain_error_page.foo", "body", "bad request"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "clear_headers", "", "Content-Length"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "clear_headers", "", "X-TEST"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGaapDomainErrorPageExists("tencentcloud_gaap_domain_error_page.foo", listenerId, domain, id),
					resource.TestCheckResourceAttrSet("tencentcloud_gaap_domain_error_page.foo", "listener_id"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "error_codes", "", "405"),
					resource.TestCheckResourceAttr("tencentcloud_gaap_domain_error_page.foo", "body", "bad request"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGaapDomainErrorPageExists("tencentcloud_gaap_domain_error_page.foo", listenerId, domain, id),
					resource.TestCheckResourceAttrSet("tencentcloud_gaap_domain_error_page.foo", "listener_id"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "error_codes", "", "406"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "error_codes", "", "504"),
					resource.TestCheckResourceAttr("tencentcloud_gaap_domain_error_page.foo", "body", "bad request"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "clear_headers", "", "Content-Length"),
					helper.CheckSchemaSetResourceAttr("tencentcloud_gaap_domain_error_page.foo", "clear_headers", "", "X-TEST"),
					resource.TestCheckResourceAttr("tencentcloud_gaap_domain_error_page.foo", "set_headers.X-TEST", "test"),
