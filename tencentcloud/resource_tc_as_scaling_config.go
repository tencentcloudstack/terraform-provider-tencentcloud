...
func resourceTencentCloudAsScalingConfigRead(d *schema.ResourceData, meta interface{}) error {
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		...
		_ = d.Set("instance_types", helper.FlattenStringList(config.InstanceTypes))
		...
		_ = d.Set("login_settings.key_ids", helper.FlattenStringList(config.LoginSettings.KeyIds))
		_ = d.Set("security_group_ids", helper.FlattenStringList(config.SecurityGroupIds))
