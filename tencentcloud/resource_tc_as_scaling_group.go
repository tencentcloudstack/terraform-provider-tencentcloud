...
func resourceTencentCloudAsScalingGroupRead(d *schema.ResourceData, meta interface{}) error {
	...
	_ = d.Set("subnet_ids", helper.FlattenStringList(scalingGroup.SubnetIdSet))
	_ = d.Set("zones", helper.FlattenStringList(scalingGroup.ZoneSet))
	_ = d.Set("default_cooldown", scalingGroup.DefaultCooldown)
	_ = d.Set("desired_capacity", scalingGroup.DesiredCapacity)
	_ = d.Set("load_balancer_ids", helper.FlattenStringList(scalingGroup.LoadBalancerIdSet))
	_ = d.Set("termination_policies", helper.FlattenStringList(scalingGroup.TerminationPolicySet))
