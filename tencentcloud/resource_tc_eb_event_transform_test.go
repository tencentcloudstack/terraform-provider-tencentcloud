		...
		Steps: []resource.TestStep{
			{
				...
				Check:  resource.ComposeTestCheckFunc(resource.TestCheckResourceAttrSet("tencentcloud_eb_event_transform.event_transform", "id")),
			},
			{
				ResourceName:      "tencentcloud_eb_event_transform.event_transform",
				ImportState:       true,
