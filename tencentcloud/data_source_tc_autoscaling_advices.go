/*
Use this data source to query detailed information of autoscaling advices
...
func dataSourceTencentCloudAutoscalingAdvices() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudAutoscalingAdvicesRead,
...
func dataSourceTencentCloudAutoscalingAdvicesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_autoscaling_advices.read")()
	...
	var autoScalingAdviceSet []*autoscaling.AutoScalingAdvice

	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeAutoscalingAdvicesByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
