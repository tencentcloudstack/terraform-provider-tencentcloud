...
func dataSourceTencentCloudRumSetUrlStatisticsRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_rum_set_url_statistics.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeRumSetUrlStatisticsByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		result = result
