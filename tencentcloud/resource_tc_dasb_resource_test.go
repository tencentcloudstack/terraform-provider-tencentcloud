		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_resource.example", "deploy_region"),
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_resource.example", "vpc_id"),
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_resource.example", "subnet_id"),
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_resource.example", "resource_edition"),
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_resource.example", "resource_node"),
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_resource.example", "time_unit"),
					...
					resource.TestCheckResourceAttrSet("tencentcloud_dasb_resource.example", "deploy_zone"),
