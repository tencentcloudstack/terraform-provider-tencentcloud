	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"type": {
				...
				Description: "Query Data type. `top`: &amp;amp;#39;CostType Sorting order by top&amp;amp;#39;.",
			},
...
func dataSourceTencentCloudRumFetchUrlInfoRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_rum_fetch_url_info.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeRumFetchUrlInfoByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		result = result
