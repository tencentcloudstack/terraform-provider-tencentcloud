...
func TestAccTencentCloudDcdbInstancesDataSource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccDataSourceDcdbInstances_basic, defaultDcdbInstanceId, defaultDcdbInstanceName, defaultDcdbInsVpcId, defaultDcdbInsIdSubnetId),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTencentCloudDataSourceID("data.tencentcloud_dcdb_instances.instances"),
					...
					resource.TestCheckResourceAttr("data.tencentcloud_dcdb_instances.instances", "list.0.instance_id", defaultDcdbInstanceId),
			...
			{
				Config: fmt.Sprintf(testAccDataSourceDcdbInstances_id, defaultDcdbInstanceId),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTencentCloudDataSourceID("data.tencentcloud_dcdb_instances.instances"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dcdb_instances.instances", "list.#"),
				),
			...
			{
				Config: fmt.Sprintf(testAccDataSourceDcdbInstances_name, defaultDcdbInstanceName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTencentCloudDataSourceID("data.tencentcloud_dcdb_instances.instances"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dcdb_instances.instances", "list.#"),
				),
			...
			{
				Config: fmt.Sprintf(testAccDataSourceDcdbInstances_disable_excluster, defaultDcdbInstanceName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTencentCloudDataSourceID("data.tencentcloud_dcdb_instances.instances"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dcdb_instances.instances", "list.#"),
				),
			...
			{
				Config: fmt.Sprintf(testAccDataSourceDcdbInstances_disable_vpc_filter, defaultDcdbInstanceId),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTencentCloudDataSourceID("data.tencentcloud_dcdb_instances.instances"),
					resource.TestCheckResourceAttrSet("data.tencentcloud_dcdb_instances.instances", "list.#"),
				),
