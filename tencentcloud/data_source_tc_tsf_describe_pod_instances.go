/*
Use this data source to query detailed information of tsf describe_pod_instances
...
func dataSourceTencentCloudTsfDescribePodInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudTsfDescribePodInstancesRead,
...
func dataSourceTencentCloudTsfDescribePodInstancesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_tsf_describe_pod_instances.read")()
	...
	if result != nil {
		...
		if result.TotalCount != nil {
			groupPodResultMap["total_count"] = result.TotalCount
		}
		...
		if result.Content != nil {
			...
			groupPodResultMap["content"] = []interface{}{contentList}
		}

		ids = append(ids, *result.GroupId)
		_ = d.Set("result", groupPodResultMap)
	}
