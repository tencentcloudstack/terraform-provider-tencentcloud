/*
Use this data source to query detailed information of ses list_send_tasks
...
func dataSourceTencentCloudSesListSendTasks() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudSesListSendTasksRead,
...
func dataSourceTencentCloudSesListSendTasksRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_ses_list_send_tasks.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeSesListSendTasksByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		data = result
		...
		for _, sendTaskData := range data {
			...
			if sendTaskData.Template != nil {
				...
				if sendTaskData.Template.TemplateID != nil {
					templateMap["template_i_d"] = sendTaskData.Template.TemplateID
				}
			...
			ids = append(ids, *sendTaskData.TaskId)
