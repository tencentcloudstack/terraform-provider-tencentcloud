/*
Use this data source to query detailed information of cdb clone_list
...
func dataSourceTencentCloudCdbCloneList() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudCdbCloneListRead,
...
func dataSourceTencentCloudCdbCloneListRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_cdb_clone_list.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeCdbCloneListByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		totalCount = result
	...
	if items != nil {
		for _, cloneItem := range items {
			...
			ids = append(ids, *cloneItem.InstanceId)
