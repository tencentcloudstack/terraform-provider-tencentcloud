...
func dataSourceTencentCloudRumPerformancePageRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_rum_performance_page.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeRumPerformancePageByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		result = result
