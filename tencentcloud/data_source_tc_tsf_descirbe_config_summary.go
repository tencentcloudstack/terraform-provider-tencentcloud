/*
Use this data source to query detailed information of tsf descirbe_config_summary
...
func dataSourceTencentCloudTsfDescirbeConfigSummary() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudTsfDescirbeConfigSummaryRead,
...
func dataSourceTencentCloudTsfDescirbeConfigSummaryRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_tsf_descirbe_config_summary.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeTsfDescirbeConfigSummaryByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		result = result
