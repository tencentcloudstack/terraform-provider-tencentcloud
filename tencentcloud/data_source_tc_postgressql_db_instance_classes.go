/*
Use this data source to query detailed information of postgressql db_instance_classes
...
import (
	...
	postgressql "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/postgres/v20170312"
	"github.com/tencentcloudstack/terraform-provider-tencentcloud/tencentcloud/internal/helper"
)

func dataSourceTencentCloudPostgressqlDbInstanceClasses() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudPostgressqlDbInstanceClassesRead,
...
func dataSourceTencentCloudPostgressqlDbInstanceClassesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_postgressql_db_instance_classes.read")()
	...
	service := PostgressqlService{client: meta.(*TencentCloudClient).apiV3Conn}

	var classInfoSet []*postgressql.ClassInfo

	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribePostgressqlDbInstanceClassesByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		classInfoSet = result
