		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("tencentcloud_wedata_integration_task_node.example", "project_id"),
					resource.TestCheckResourceAttrSet("tencentcloud_wedata_integration_task_node.example", "task_id"),
					resource.TestCheckResourceAttrSet("tencentcloud_wedata_integration_task_node.example", "name"),
					resource.TestCheckResourceAttrSet("tencentcloud_wedata_integration_task_node.example", "node_type"),
