		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.status", "list.#", "1"),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.status", "list.0.instance_id", defaultTdcpgInstanceId),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.status", "list.0.instance_name", defaultTdcpgInstanceName),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.status", "list.0.cluster_id", defaultTdcpgClusterId),
					resource.TestCheckResourceAttrSet("data.tencentcloud_tdcpg_instances.status", "list.0.endpoint_id"),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.status", "list.0.region", defaultRegion),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.status", "list.0.zone", defaultTdcpgZone),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.type", "list.#", "1"),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.type", "list.0.instance_id", defaultTdcpgInstanceId),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.type", "list.0.instance_name", defaultTdcpgInstanceName),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.type", "list.0.cluster_id", defaultTdcpgClusterId),
					resource.TestCheckResourceAttrSet("data.tencentcloud_tdcpg_instances.type", "list.0.endpoint_id"),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.type", "list.0.region", defaultRegion),
					resource.TestCheckResourceAttr("data.tencentcloud_tdcpg_instances.type", "list.0.zone", defaultTdcpgZone),
