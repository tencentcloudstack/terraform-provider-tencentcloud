		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("tencentcloud_cdwpg_instance.instance", "charge_properties.#", "1"),
					resource.TestCheckResourceAttrSet("tencentcloud_cdwpg_instance.instance", "resources.#", "2"),
