			...
			if metricData.Points != nil {
				...
				for _, points := range metricData.Points {
					...
					if points.Dimensions != nil {
						...
						pointsMap["dimensions"] = []interface{}{dimensionsList}
					}
					...
					if points.Values != nil {
						...
						pointsMap["values"] = []interface{}{valuesList}
					}

					pointsList = append(pointsList, pointsMap)
				}

				metricDataMap["points"] = []interface{}{pointsList}
			}

			ids = append(ids, *metricData.Namespace)
