	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"service_type": {
				...
				Description:  "Acceleration domain name service type. `web`: static acceleration, `download`: download acceleration, `media`: streaming media VOD acceleration, `hybrid`: static and dynamic acceleration, `dynamic`: dynamic acceleration.",
			},
			"project_id": {
				Type:        schema.TypeInt,
				Optional:    true,
