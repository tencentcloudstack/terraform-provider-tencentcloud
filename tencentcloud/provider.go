...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"tencentcloud_mariadb_clone_account":                      resourceTencentCloudMariadbCloneAccount(),
			"tencentcloud_mariadb_close_db_extranet_access":           resourceTencentCloudMariadbCloseDBExtranetAccess(),
			"tencentcloud_mariadb_copy_account_privileges":            resourceTencentCloudMariadbCopyAccountPrivileges(),
			"tencentcloud_mariadb_create_tmp_instance":                resourceTencentCloudMariadbCreateTmpInstance(),
			"tencentcloud_mariadb_flush_binlog":                       resourceTencentCloudMariadbFlushBinlog(),
			"tencentcloud_mariadb_grant_account_privileges":           resourceTencentCloudMariadbGrantAccountPrivileges(),
