...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"tencentcloud_ssl_check_certificate_chain":                         resourceTencentCloudSslCheckCertificateChainOperation(),
			"tencentcloud_ssl_complete_certificate":                            resourceTencentCloudSslCompleteCertificateOperation(),
			"tencentcloud_ssl_deploy_certificate_instance":                     resourceTencentCloudSslDeployCertificateInstanceOperation(),
			"tencentcloud_ssl_deploy_certificate_record_retry":                 resourceTencentCloudSslDeployCertificateRecordRetryOperation(),
			"tencentcloud_ssl_deploy_certificate_record_rollback":              resourceTencentCloudSslDeployCertificateRecordRollbackOperation(),
			"tencentcloud_ssl_download_certificate":                            resourceTencentCloudSslDownloadCertificateOperation(),
			"tencentcloud_ssl_replace_certificate":                             resourceTencentCloudSslReplaceCertificateOperation(),
			"tencentcloud_ssl_revoke_certificate":                              resourceTencentCloudSslRevokeCertificateOperation(),
			"tencentcloud_ssl_update_certificate_instance":                     resourceTencentCloudSslUpdateCertificateInstanceOperation(),
			"tencentcloud_ssl_update_certificate_record_retry":                 resourceTencentCloudSslUpdateCertificateRecordRetryOperation(),
			"tencentcloud_ssl_update_certificate_record_rollback":              resourceTencentCloudSslUpdateCertificateRecordRollbackOperation(),
			"tencentcloud_ssl_upload_revoke_letter":                            resourceTencentCloudSslUploadRevokeLetterOperation(),
		},
