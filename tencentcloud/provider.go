...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"tencentcloud_cam_role_name_as_identifier":                   resourceTencentCloudCamRoleNameAsIdentifier(),
			"tencentcloud_cam_user":                                      resourceTencentCloudCamUser(),
			"tencentcloud_cam_policy":                                    resourceTencentCloudCamPolicy(),
			"tencentcloud_cam_policy_name_as_identifier":                 resourceTencentCloudCamPolicyNameAsIdentifier(),
			"tencentcloud_cam_role_policy_attachment":                    resourceTencentCloudCamRolePolicyAttachment(),
			"tencentcloud_cam_role_policy_attachment_name_as_identifier": resourceTencentCloudCamRolePolicyAttachmentNameAsIdentifier(),
