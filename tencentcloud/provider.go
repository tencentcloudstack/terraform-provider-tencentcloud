...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"tencentcloud_gaap_domain_error_page_info_list": dataSourceTencentCloudGaapDomainErrorPageInfoList(),
		},
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"tencentcloud_gaap_domain_error_page_info":    resourceTencentCloudGaapDomainErrorPageInfo(),
		},
