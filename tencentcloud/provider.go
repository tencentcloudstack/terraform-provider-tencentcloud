...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"tencentcloud_apigateway_a_p_i":                                    dataSourceTencentCloudApigatewayAPI(),
			"tencentcloud_apigateway_api_app":                                  dataSourceTencentCloudApigatewayApiApp(),
			"tencentcloud_apigateway_plugin":                                   dataSourceTencentCloudApigatewayPlugin(),
			"tencentcloud_apigateway_service":                                  dataSourceTencentCloudApigatewayService(),
			"tencentcloud_apigateway_upstream":                                 dataSourceTencentCloudApigatewayUpstream(),
			"tencentcloud_autoscaling_advices":                                 dataSourceTencentCloudAutoscalingAdvices(),
			"tencentcloud_autoscaling_limits":                                  dataSourceTencentCloudAutoscalingLimits(),
			"tencentcloud_autoscaling_last_activity":                           dataSourceTencentCloudAutoscalingLastActivity(),
			"tencentcloud_autoscaling_complete_lifecycle":                      resourceTencentCloudAutoscalingCompleteLifecycle(),
			"tencentcloud_autoscaling_execute_scaling_policy":                  resourceTencentCloudAutoscalingExecuteScalingPolicy(),
			"tencentcloud_autoscaling_scale_in_instances":                      resourceTencentCloudAutoscalingScaleInInstances(),
			"tencentcloud_autoscaling_scale_out_instances":                     resourceTencentCloudAutoscalingScaleOutInstances(),
			"tencentcloud_bi_embed_interval":                                   resourceTencentCloudBiEmbedInterval(),
			"tencentcloud_vpc_ccn_bandwidth":                                   dataSourceTencentCloudVpcCcn_bandwidth(),
			"tencentcloud_vpc_cross_border_compliance":                         dataSourceTencentCloudVpcCrossBorderCompliance(),
			"tencentcloud_vpc_cross_border_flow_monitor":                       dataSourceTencentCloudVpcCrossBorderFlowMonitor(),
			"tencentcloud_vpc_tenant_ccn":                                      dataSourceTencentCloudVpcTenantCcn(),
			"tencentcloud_vpc_ccn_instances_reject_attach":                     resourceTencentCloudVpcCcnInstancesRejectAttach(),
			"tencentcloud_cdb_backup_databases":                                dataSourceTencentCloudCdbBackupDatabases(),
			"tencentcloud_cdb_backup_overview":                                 dataSourceTencentCloudCdbBackupOverview(),
			"tencentcloud_cdb_backup_summaries":                                dataSourceTencentCloudCdbBackupSummaries(),
			"tencentcloud_cdb_backup_tables":                                   dataSourceTencentCloudCdbBackupTables(),
			"tencentcloud_cdb_bin_log":                                         dataSourceTencentCloudCdbBinLog(),
			"tencentcloud_cdb_binlog_backup_overview":                          dataSourceTencentCloudCdbBinlogBackupOverview(),
			"tencentcloud_cdb_clone_list":                                      dataSourceTencentCloudCdbCloneList(),
			"tencentcloud_cdb_data_backup_overview":                            dataSourceTencentCloudCdbDataBackupOverview(),
			"tencentcloud_cdb_databases":                                       dataSourceTencentCloudCdbDatabases(),
			"tencentcloud_cdb_db_features":                                     dataSourceTencentCloudCdbDbFeatures(),
			"tencentcloud_cdb_error_log":                                       dataSourceTencentCloudCdbErrorLog(),
			"tencentcloud_cdb_inst_tables":                                     dataSourceTencentCloudCdbInstTables(),
			"tencentcloud_cdb_instance_charset":                                dataSourceTencentCloudCdbInstanceCharset(),
			"tencentcloud_cdb_instance_info":                                   dataSourceTencentCloudCdbInstanceInfo(),
			"tencentcloud_cdb_instance_param_record":                           dataSourceTencentCloudCdbInstanceParamRecord(),
			"tencentcloud_cdb_instance_reboot_time":                            dataSourceTencentCloudCdbInstanceRebootTime(),
			"tencentcloud_cdb_param_templates":                                 dataSourceTencentCloudCdbParamTemplates(),
			"tencentcloud_cdb_project_security_group":                          dataSourceTencentCloudCdbProjectSecurityGroup(),
			"tencentcloud_cdb_ro_min_scale":                                    dataSourceTencentCloudCdbRoMinScale(),
			"tencentcloud_cdb_rollback_range_time":                             dataSourceTencentCloudCdbRollbackRangeTime(),
			"tencentcloud_cdb_slow_log":                                        dataSourceTencentCloudCdbSlowLog(),
			"tencentcloud_cdb_slow_log_data":                                   dataSourceTencentCloudCdbSlowLogData(),
			"tencentcloud_cdb_supported_privileges":                            dataSourceTencentCloudCdbSupportedPrivileges(),
			"tencentcloud_cdb_switch_record":                                   dataSourceTencentCloudCdbSwitchRecord(),
			"tencentcloud_cdb_tables":                                          dataSourceTencentCloudCdbTables(),
			"tencentcloud_cdb_uploaded_files":                                  dataSourceTencentCloudCdbUploadedFiles(),
			"tencentcloud_cdb_instance_encryption":                             resourceTencentCloudCdbInstanceEncryption(),
			"tencentcloud_cdb_renew_d_b_instance":                              resourceTencentCloudCdbRenewDBInstance(),
			"tencentcloud_cdb_restart_d_b_instances":                           resourceTencentCloudCdbRestartDBInstances(),
			"tencentcloud_cdb_ro_group_load":                                   resourceTencentCloudCdbRoGroupLoad(),
			"tencentcloud_cdb_ro_instance_ip":                                  resourceTencentCloudCdbRoInstanceIp(),
			"tencentcloud_cdb_rollback":                                        resourceTencentCloudCdbRollback(),
			"tencentcloud_cdb_root_account":                                    resourceTencentCloudCdbRootAccount(),
			"tencentcloud_cdb_switch_master_slave":                             resourceTencentCloudCdbSwitchMasterSlave(),
			"tencentcloud_cfs_auto_snapshot_policy":                            dataSourceTencentCloudCfsAutoSnapshotPolicy(),
			"tencentcloud_cfw_nat_fw_switch":                                   dataSourceTencentCloudCfwNatFwSwitch(),
			"tencentcloud_ckafka_ckafka_zone":                                  dataSourceTencentCloudCkafkaCkafkaZone(),
			"tencentcloud_ckafka_renew_ckafka_instance":                        resourceTencentCloudCkafkaRenewCkafkaInstance(),
			...
			"tencentcloud_redis_change_master_operation":                       resourceTencentCloudRedisChangeMasterOperation(),
			"tencentcloud_redis_clear_instance_operation":                      resourceTencentCloudRedisClearInstanceOperation(),
			"tencentcloud_redis_destroy_postpaid_instance":                     resourceTencentCloudRedisDestroyPostpaidInstance(),
			"tencentcloud_redis_destroy_prepaid_instance":                      resourceTencentCloudRedisDestroyPrepaidInstance(),
			...
			"tencentcloud_live_backup_stream":                                  dataSourceTencentCloudLiveBackupStream(),
			"tencentcloud_live_enable_optimal_switching":                       resourceTencentCloudLiveEnableOptimalSwitching(),
			"tencentcloud_live_live_monitor":                                   resourceTencentCloudLiveLive_monitor(),
			"tencentcloud_live_pullpush_task":                                  resourceTencentCloudLivePullpush_task(),
			"tencentcloud_live_describe_deliver_log_down_list":                 dataSourceTencentCloudLiveDescribeDeliverLogDownList(),
			"tencentcloud_live_describe_live_stream_monitor_list":              dataSourceTencentCloudLiveDescribeLiveStreamMonitorList(),
			"tencentcloud_live_describe_live_x_p2_p_detail_info_list":          dataSourceTencentCloudLiveDescribeLiveXP2PDetailInfoList(),
			"tencentcloud_live_describe_monitor_report":                        dataSourceTencentCloudLiveDescribeMonitorReport(),
			"tencentcloud_live_describe_live_pad_templates":                    dataSourceTencentCloudLiveDescribeLivePadTemplates(),
			"tencentcloud_live_describe_live_pull_stream_task_status":          dataSourceTencentCloudLiveDescribeLivePullStreamTaskStatus(),
			"tencentcloud_live_describe_time_shift_record_detail":              dataSourceTencentCloudLiveDescribeTimeShiftRecordDetail(),
			"tencentcloud_live_describe_time_shift_stream_list":                dataSourceTencentCloudLiveDescribeTimeShiftStreamList(),
			"tencentcloud_cvm_chc_attribute":                                   resourceTencentCloudCvmChcAttribute(),
			"tencentcloud_cvm_program_fpga_image":                              resourceTencentCloudCvmProgramFpgaImage(),
			"tencentcloud_cvm_sync_images":                                     resourceTencentCloudCvmSyncImages(),
			...
			"tencentcloud_cvm_modify_image_share_permission":                   resourceTencentCloudCvmModifyImageSharePermission(),
			...
			"tencentcloud_cvm_renew_hosts":                                     resourceTencentCloudCvmRenewHosts(),
			"tencentcloud_cvm_renew_instance":                                  resourceTencentCloudCvmRenewInstance(),
			"tencentcloud_cwp_describe_machines_simple":                        dataSourceTencentCloudCwpDescribeMachinesSimple(),
			"tencentcloud_cynosdb_resource_package_sale_spec":                  dataSourceTencentCloudCynosdbResourcePackageSaleSpec(),
			"tencentcloud_cynosdb_rollback_time_validity":                      dataSourceTencentCloudCynosdbRollbackTimeValidity(),
			"tencentcloud_cynosdb_cluster_version":                             resourceTencentCloudCynosdbClusterVersion(),
			"tencentcloud_cynosdb_cluster_zone":                                resourceTencentCloudCynosdbClusterZone(),
			...
			"tencentcloud_cynosdb_instance":                                    resourceTencentCloudCynosdbInstance(),
			"tencentcloud_cynosdb_instance_name":                               resourceTencentCloudCynosdbInstanceName(),
			...
			"tencentcloud_cynosdb_rollback_cluster":                            resourceTencentCloudCynosdbRollbackCluster(),
			"tencentcloud_cynosdb_vip_vport":                                   resourceTencentCloudCynosdbVipVport(),
			"tencentcloud_dbbrain_health_score":                                dataSourceTencentCloudDbbrainHealthScore(),
			"tencentcloud_dbbrain_describe_slow_logs":                          dataSourceTencentCloudDbbrainDescribeSlowLogs(),
			"tencentcloud_dbbrain_describe_sql_template":                       dataSourceTencentCloudDbbrainDescribeSqlTemplate(),
			"tencentcloud_dbbrain_describe_d_b_space_status":                   dataSourceTencentCloudDbbrainDescribeDBSpaceStatus(),
			"tencentcloud_dbbrain_describe_top_space_schemas":                  dataSourceTencentCloudDbbrainDescribeTopSpaceSchemas(),
			"tencentcloud_dbbrain_describe_top_space_tables":                   dataSourceTencentCloudDbbrainDescribeTopSpaceTables(),
			"tencentcloud_dbbrain_verify_user_account":                         dataSourceTencentCloudDbbrainVerifyUserAccount(),
			"tencentcloud_dbbrain_modify_diag_db_instance_operation":           resourceTencentCloudDbbrainModifyDiagDbInstanceOperation(),
			"tencentcloud_dcdb_database_table":                                 dataSourceTencentCloudDcdbDatabaseTable(),
			"tencentcloud_dcdb_activate_hour_instance":                         resourceTencentCloudDcdbActivateHourInstance(),
			"tencentcloud_dcdb_cancel_dcn_job":                                 resourceTencentCloudDcdbCancelDcnJob(),
			"tencentcloud_dcdb_close_d_b_extranet_access":                      resourceTencentCloudDcdbCloseDBExtranetAccess(),
			"tencentcloud_dcdb_flush_binlog":                                   resourceTencentCloudDcdbFlushBinlog(),
			"tencentcloud_dcdb_isolate_hour_instance":                          resourceTencentCloudDcdbIsolateHourInstance(),
			"tencentcloud_dcdb_modify_real_server_access_strategy":             resourceTencentCloudDcdbModifyRealServerAccessStrategy(),
			"tencentcloud_dcdb_modify_instance_project":                        resourceTencentCloudDcdbModifyInstanceProject(),
			"tencentcloud_dcdb_modify_instance_network":                        resourceTencentCloudDcdbModifyInstanceNetwork(),
			"tencentcloud_dcdb_open_d_b_extranet_access":                       resourceTencentCloudDcdbOpenDBExtranetAccess(),
			"tencentcloud_dcdb_renew_d_c_d_b_instance":                         resourceTencentCloudDcdbRenewDCDBInstance(),
			"tencentcloud_dcdb_reset_account_password":                         resourceTencentCloudDcdbResetAccountPassword(),
			"tencentcloud_dcdb_switch_d_b_instance_h_a":                        resourceTencentCloudDcdbSwitchDBInstanceHA(),
			"tencentcloud_dts_compare_report":                                  dataSourceTencentCloudDtsCompareReport(),
			"tencentcloud_dts_migrate_job_resume":                              resourceTencentCloudDtsMigrateJobResume(),
			"tencentcloud_dts_sync_job_resume":                                 resourceTencentCloudDtsSyncJobResume(),
			"tencentcloud_eb_rule":                                             dataSourceTencentCloudEbRule(),
			"tencentcloud_eb_put_events":                                       resourceTencentCloudEbPutEvents(),
			"tencentcloud_vpc_network_account_type":                            dataSourceTencentCloudVpcNetworkAccountType(),
			"tencentcloud_vpc_address_quota":                                   dataSourceTencentCloudVpcAddressQuota(),
			"tencentcloud_vpc_address_transform":                               resourceTencentCloudVpcAddressTransform(),
			"tencentcloud_vpc_public_address_adjust":                           resourceTencentCloudVpcPublicAddressAdjust(),
			"tencentcloud_vpc_address_internet_charge_type_modify":             resourceTencentCloudVpcAddressInternetChargeTypeModify(),
			"tencentcloud_vpc_normal_address_return":                           resourceTencentCloudVpcNormalAddressReturn(),
			"tencentcloud_kms_describe_white_box_decrypt_key":                  dataSourceTencentCloudKmsDescribeWhiteBoxDecryptKey(),
			"tencentcloud_kms_describe_white_box_device_fingerprints":          dataSourceTencentCloudKmsDescribeWhiteBoxDeviceFingerprints(),
			"tencentcloud_kms_describe_white_box_key_details":                  dataSourceTencentCloudKmsDescribeWhiteBoxKeyDetails(),
			"tencentcloud_kms_get_public_key":                                  dataSourceTencentCloudKmsGetPublicKey(),
			"tencentcloud_kms_archive_key":                                     resourceTencentCloudKmsArchiveKey(),
			"tencentcloud_kms_cancel_key_archive":                              resourceTencentCloudKmsCancelKeyArchive(),
			"tencentcloud_kms_cancel_key_deletion":                             resourceTencentCloudKmsCancelKeyDeletion(),
			...
			"tencentcloud_lighthouse_modify_disk_renew_flag":                   resourceTencentCloudLighthouseModifyDiskRenewFlag(),
			"tencentcloud_lighthouse_modify_instance_renew_flag":               resourceTencentCloudLighthouseModifyInstanceRenewFlag(),
			"tencentcloud_lighthouse_reboot_instance":                          resourceTencentCloudLighthouseRebootInstance(),
			"tencentcloud_lighthouse_renew_disks":                              resourceTencentCloudLighthouseRenewDisks(),
			"tencentcloud_lighthouse_renew_instance":                           resourceTencentCloudLighthouseRenewInstance(),
			"tencentcloud_lighthouse_reset_instance":                           resourceTencentCloudLighthouseResetInstance(),
			"tencentcloud_lighthouse_reset_instances_password":                 resourceTencentCloudLighthouseResetInstancesPassword(),
			...
			"tencentcloud_mariadb_activate_hour_db_instance":                   resourceTencentCloudMariadbActivateHourDbInstance(),
			"tencentcloud_mariadb_cancel_dcn_job":                              resourceTencentCloudMariadbCancelDcnJob(),
			"tencentcloud_mariadb_close_d_b_extranet_access":                   resourceTencentCloudMariadbCloseDBExtranetAccess(),
			"tencentcloud_mariadb_flush_binlog":                                resourceTencentCloudMariadbFlushBinlog(),
			"tencentcloud_mariadb_isolate_hour_instance":                       resourceTencentCloudMariadbIsolateHourInstance(),
			"tencentcloud_mariadb_isolate_instance":                            resourceTencentCloudMariadbIsolateInstance(),
			"tencentcloud_mariadb_access_strategy":                             resourceTencentCloudMariadbAccessStrategy(),
			"tencentcloud_mariadb_modify_instance_project":                     resourceTencentCloudMariadbModifyInstanceProject(),
			"tencentcloud_mariadb_network":                                     resourceTencentCloudMariadbNetwork(),
			"tencentcloud_mariadb_sync_mode":                                   resourceTencentCloudMariadbSyncMode(),
			"tencentcloud_mariadb_open_d_b_extranet_access":                    resourceTencentCloudMariadbOpenDBExtranetAccess(),
			"tencentcloud_mariadb_renew_instance":                              resourceTencentCloudMariadbRenewInstance(),
			"tencentcloud_mariadb_reset_password":                              resourceTencentCloudMariadbResetPassword(),
			"tencentcloud_mariadb_restart_instance":                            resourceTencentCloudMariadbRestartInstance(),
			"tencentcloud_mariadb_switch_h_a":                                  resourceTencentCloudMariadbSwitchHA(),
			"tencentcloud_monitor_plugin_overviews":                            dataSourceTencentCloudMonitorPluginOverviews(),
			"tencentcloud_monitor_prom_regions":                                dataSourceTencentCloudMonitorPromRegions(),
			"tencentcloud_monitor_enable_grafana_internet":                     resourceTencentCloudMonitorEnableGrafanaInternet(),
			"tencentcloud_mps_adaptive_dynamic_streaming_templates":            dataSourceTencentCloudMpsAdaptiveDynamicStreamingTemplates(),
			"tencentcloud_mps_ai_analysis_templates":                           dataSourceTencentCloudMpsAiAnalysisTemplates(),
			"tencentcloud_mps_ai_recognition_templates":                        dataSourceTencentCloudMpsAiRecognitionTemplates(),
			"tencentcloud_mps_animated_graphics_templates":                     dataSourceTencentCloudMpsAnimatedGraphicsTemplates(),
			"tencentcloud_mps_content_review_templates":                        dataSourceTencentCloudMpsContentReviewTemplates(),
			"tencentcloud_mps_describe_media_meta_data":                        dataSourceTencentCloudMpsDescribeMediaMetaData(),
			"tencentcloud_mps_image_sprite_templates":                          dataSourceTencentCloudMpsImageSpriteTemplates(),
			"tencentcloud_mps_person_samples":                                  dataSourceTencentCloudMpsPersonSamples(),
			"tencentcloud_mps_sample_snapshot_templates":                       dataSourceTencentCloudMpsSampleSnapshotTemplates(),
			"tencentcloud_mps_snapshot_by_timeoffset_templates":                dataSourceTencentCloudMpsSnapshotByTimeoffsetTemplates(),
			"tencentcloud_mps_transcode_templates":                             dataSourceTencentCloudMpsTranscodeTemplates(),
			"tencentcloud_mps_watermark_templates":                             dataSourceTencentCloudMpsWatermarkTemplates(),
			"tencentcloud_mps_word_samples":                                    dataSourceTencentCloudMpsWordSamples(),
			"tencentcloud_mps_workflows":                                       dataSourceTencentCloudMpsWorkflows(),
			"tencentcloud_mps_edit_media":                                      resourceTencentCloudMpsEditMedia(),
			"tencentcloud_mps_execute_function":                                resourceTencentCloudMpsExecuteFunction(),
			"tencentcloud_mps_startflow":                                       resourceTencentCloudMpsStartflow(),
			"tencentcloud_mps_stopflow":                                        resourceTencentCloudMpsStopflow(),
			"tencentcloud_mps_manage_task":                                     resourceTencentCloudMpsManageTask(),
			"tencentcloud_mps_process_live_stream":                             resourceTencentCloudMpsProcessLiveStream(),
			"tencentcloud_mps_process_media":                                   resourceTencentCloudMpsProcessMedia(),
			"tencentcloud_mps_withdraws_watermark":                             resourceTencentCloudMpsWithdrawsWatermark(),
			"tencentcloud_vpc_nat_dc_route":                                    dataSourceTencentCloudVpcNatDcRoute(),
			"tencentcloud_vpc_refresh_nat_dc_route":                            resourceTencentCloudVpcRefreshNatDcRoute(),
			"tencentcloud_oceanus_cluster":                                     dataSourceTencentCloudOceanusCluster(),
			"tencentcloud_oceanus_log":                                         dataSourceTencentCloudOceanusLog(),
			"tencentcloud_organization_quit_organization":                      resourceTencentCloudOrganizationQuitOrganization(),
			"tencentcloud_postgres_backup_download_u_r_l":                      dataSourceTencentCloudPostgresBackupDownloadURL(),
			"tencentcloud_postgres_base_backup":                                dataSourceTencentCloudPostgresBaseBackup(),
			"tencentcloud_postgres_d_b_instance_classes":                       dataSourceTencentCloudPostgresDBInstanceClasses(),
			"tencentcloud_postgres_recovery_time":                              dataSourceTencentCloudPostgresRecoveryTime(),
			"tencentcloud_postgres_d_b_instance_versions":                      dataSourceTencentCloudPostgresDBInstanceVersions(),
			"tencentcloud_postgres_describe_default_parameters":                dataSourceTencentCloudPostgresDescribeDefaultParameters(),
			"tencentcloud_postgres_parameter_templates":                        dataSourceTencentCloudPostgresParameterTemplates(),
			"tencentcloud_postgres_read_only_group":                            dataSourceTencentCloudPostgresReadOnlyGroup(),
			"tencentcloud_postgres_regions":                                    dataSourceTencentCloudPostgresRegions(),
			"tencentcloud_postgres_zones":                                      dataSourceTencentCloudPostgresZones(),
			"tencentcloud_postgres_clone_d_b_instance":                         resourceTencentCloudPostgresCloneDBInstance(),
			"tencentcloud_postgres_create_base_backup":                         resourceTencentCloudPostgresCreateBaseBackup(),
			"tencentcloud_postgres_create_read_only_d_b_instance":              resourceTencentCloudPostgresCreateReadOnlyDBInstance(),
			"tencentcloud_postgres_delete_base_backup":                         resourceTencentCloudPostgresDeleteBaseBackup(),
			"tencentcloud_postgres_delete_log_backup":                          resourceTencentCloudPostgresDeleteLogBackup(),
			"tencentcloud_postgres_dis_isolate_d_b_instances":                  resourceTencentCloudPostgresDisIsolateDBInstances(),
			"tencentcloud_postgres_modify_account_remark":                      resourceTencentCloudPostgresModifyAccountRemark(),
			"tencentcloud_postgres_modify_d_b_instance_charge_type":            resourceTencentCloudPostgresModifyDBInstanceChargeType(),
			"tencentcloud_postgres_modify_d_b_instance_read_only_group":        resourceTencentCloudPostgresModifyDBInstanceReadOnlyGroup(),
			"tencentcloud_postgres_rebalance_read_only_group":                  resourceTencentCloudPostgresRebalanceReadOnlyGroup(),
			"tencentcloud_postgres_renew_instance":                             resourceTencentCloudPostgresRenewInstance(),
			"tencentcloud_postgres_restart_d_b_instance":                       resourceTencentCloudPostgresRestartDBInstance(),
			...
			"tencentcloud_pts_operate_job":                                     resourceTencentCloudPtsOperateJob(),
			"tencentcloud_pts_operate_cron_job":                                resourceTencentCloudPtsOperateCronJob(),
			"tencentcloud_rum_log_url_info":                                    dataSourceTencentCloudRumLogUrlInfo(),
			...
			"tencentcloud_scf_function_event_invoke_config":                    dataSourceTencentCloudScfFunctionEventInvokeConfig(),
			"tencentcloud_scf_provisioned_concurrency_config":                  dataSourceTencentCloudScfProvisionedConcurrencyConfig(),
			"tencentcloud_scf_reserved_concurrency_config":                     dataSourceTencentCloudScfReservedConcurrencyConfig(),
			...
			"tencentcloud_ses_list_black_email_address":                        dataSourceTencentCloudSesListBlackEmailAddress(),
			"tencentcloud_ses_list_email_identities":                           dataSourceTencentCloudSesListEmailIdentities(),
			"tencentcloud_ses_list_receivers":                                  dataSourceTencentCloudSesListReceivers(),
			"tencentcloud_ses_list_send_tasks":                                 dataSourceTencentCloudSesListSendTasks(),
			...
			"tencentcloud_sqlserver_datasource_backup_command":                 dataSourceTencentCloudSqlserverDatasourceBackupCommand(),
			"tencentcloud_sqlserver_datasource_backup_by_flow_id":              dataSourceTencentCloudSqlserverDatasourceBackupByFlowId(),
			"tencentcloud_sqlserver_datasource_backup_upload_size":             dataSourceTencentCloudSqlserverDatasourceBackupUploadSize(),
			"tencentcloud_sqlserver_datasource_cross_region_zone":              dataSourceTencentCloudSqlserverDatasourceCrossRegionZone(),
			"tencentcloud_sqlserver_datasource_d_b_charsets":                   dataSourceTencentCloudSqlserverDatasourceDBCharsets(),
			"tencentcloud_sqlserver_datasource_ins_attribute":                  dataSourceTencentCloudSqlserverDatasourceInsAttribute(),
			"tencentcloud_sqlserver_datasource_regions":                        dataSourceTencentCloudSqlserverDatasourceRegions(),
			...
			"tencentcloud_ssm_describe_rotation_detail":                        dataSourceTencentCloudSsmDescribeRotationDetail(),
			"tencentcloud_ssm_describe_rotation_history":                       dataSourceTencentCloudSsmDescribeRotationHistory(),
			"tencentcloud_ssm_describe_supported_products":                     dataSourceTencentCloudSsmDescribeSupportedProducts(),
			"tencentcloud_ssm_get_service_status":                              dataSourceTencentCloudSsmGetServiceStatus(),
			"tencentcloud_ssm_get_s_s_h_key_pair_value":                        dataSourceTencentCloudSsmGetSSHKeyPairValue(),
			"tencentcloud_ssm_describe_async_request_info":                     resourceTencentCloudSsmDescribeAsyncRequestInfo(),
			"tencentcloud_ssm_rotate_product_secret":                           resourceTencentCloudSsmRotateProductSecret(),
			"tencentcloud_tdmq_queue":                                          dataSourceTencentCloudTdmqQueue(),
			"tencentcloud_tdmq_subscribe":                                      dataSourceTencentCloudTdmqSubscribe(),
			"tencentcloud_tdmq_topic":                                          dataSourceTencentCloudTdmqTopic(),
			"tencentcloud_tcr_replication_instance":                            dataSourceTencentCloudTcrReplicationInstance(),
			"tencentcloud_tcr_tag_retention_execution":                         dataSourceTencentCloudTcrTagRetentionExecution(),
			"tencentcloud_tcr_tag_retention_execution_task":                    dataSourceTencentCloudTcrTagRetentionExecutionTask(),
			"tencentcloud_tcr_webhook_trigger_log":                             dataSourceTencentCloudTcrWebhookTriggerLog(),
			"tencentcloud_tcr_image_signature":                                 resourceTencentCloudTcrImageSignature(),
			"tencentcloud_tcr_delete_image":                                    resourceTencentCloudTcrDeleteImage(),
			"tencentcloud_tcr_manage_replication":                              resourceTencentCloudTcrManageReplication(),
			"tencentcloud_tcr_instance":                                        resourceTencentCloudTcrInstance(),
			"tencentcloud_tdmq_dead_letter_source_queue":                       dataSourceTencentCloudTdmqDeadLetterSourceQueue(),
			"tencentcloud_tdmq_rabbitmq_virtual_host_list":                     dataSourceTencentCloudTdmqRabbitmqVirtualHostList(),
			...
			"tencentcloud_teo_ownership":                                       resourceTencentCloudTeoOwnership(),
			"tencentcloud_tse_gateway_config":                                  dataSourceTencentCloudTseGatewayConfig(),
			"tencentcloud_tse_group_list":                                      dataSourceTencentCloudTseGroupList(),
			"tencentcloud_tsf_descirbe_config_summary":                         dataSourceTencentCloudTsfDescirbeConfigSummary(),
			"tencentcloud_tsf_description_container_group":                     dataSourceTencentCloudTsfDescriptionContainerGroup(),
			"tencentcloud_tsf_describe_container_groups":                       dataSourceTencentCloudTsfDescribeContainerGroups(),
			"tencentcloud_tsf_describe_delivery_config_by_group_i_d":           dataSourceTencentCloudTsfDescribeDeliveryConfigByGroupID(),
			"tencentcloud_tsf_describe_delivery_configs":                       dataSourceTencentCloudTsfDescribeDeliveryConfigs(),
			"tencentcloud_tsf_describe_gateway_all_group_apis":                 dataSourceTencentCloudTsfDescribeGatewayAllGroupApis(),
			"tencentcloud_tsf_describe_group_gateways":                         dataSourceTencentCloudTsfDescribeGroupGateways(),
			"tencentcloud_tsf_describe_group_instances":                        dataSourceTencentCloudTsfDescribeGroupInstances(),
			"tencentcloud_tsf_describe_pod_instances":                          dataSourceTencentCloudTsfDescribePodInstances(),
			"tencentcloud_tsf_describe_public_config_summary":                  dataSourceTencentCloudTsfDescribePublicConfigSummary(),
			"tencentcloud_tsf_describe_usable_unit_namespaces":                 dataSourceTencentCloudTsfDescribeUsableUnitNamespaces(),
			"tencentcloud_tsf_describe_ms_api_list":                            dataSourceTencentCloudTsfDescribeMsApiList(),
			"tencentcloud_tsf_add_cluster_instances":                           resourceTencentCloudTsfAddClusterInstances(),
			"tencentcloud_vpc_vpn_customer_gateway_vendors":                    dataSourceTencentCloudVpcVpnCustomerGatewayVendors(),
			"tencentcloud_vpc_vpn_connection_default_health_check_ip_generate": resourceTencentCloudVpcVpnConnectionDefaultHealthCheckIpGenerate(),
			"tencentcloud_vpc_vpn_connection_reset":                            resourceTencentCloudVpcVpnConnectionReset(),
			"tencentcloud_vpc_vpn_customer_gateway_configuration_download":     resourceTencentCloudVpcVpnCustomerGatewayConfigurationDownload(),
			"tencentcloud_vpc_vpn_gateway_ccn_routes":                          resourceTencentCloudVpcVpnGatewayCcnRoutes(),
			"tencentcloud_vpc_vpn_gateway_renew":                               resourceTencentCloudVpcVpnGatewayRenew(),
			"tencentcloud_waf_cipher":                                          dataSourceTencentCloudWafCipher(),
			"tencentcloud_waf_domain_list":                                     dataSourceTencentCloudWafDomainList(),
			"tencentcloud_waf_port":                                            dataSourceTencentCloudWafPort(),
			"tencentcloud_waf_tls_version":                                     dataSourceTencentCloudWafTlsVersion(),
			"tencentcloud_waf_modify_access_period":                            resourceTencentCloudWafModifyAccessPeriod(),
			"tencentcloud_wedata_datasouce__describe_data_source_list":         dataSourceTencentCloudWedataDatasouce_DescribeDataSourceList(),
			"tencentcloud_wedata_datasouce__describe_data_source_without_info": dataSourceTencentCloudWedataDatasouce_DescribeDataSourceWithoutInfo(),
		},
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"tencentcloud_antiddos_boundip":                                    resourceTencentCloudAntiddosBoundip(),
			"tencentcloud_apigateway_a_p_i":                                    resourceTencentCloudApigatewayAPI(),
			"tencentcloud_apigateway_api_app":                                  resourceTencentCloudApigatewayApiApp(),
			"tencentcloud_apigateway_plugin":                                   resourceTencentCloudApigatewayPlugin(),
			"tencentcloud_apigateway_service":                                  resourceTencentCloudApigatewayService(),
			"tencentcloud_apigateway_usage_plan":                               resourceTencentCloudApigatewayUsagePlan(),
			"tencentcloud_apigateway_api_key":                                  resourceTencentCloudApigatewayApiKey(),
			"tencentcloud_apigateway_upstream":                                 resourceTencentCloudApigatewayUpstream(),
			"tencentcloud_autoscaling_auto_scaling_group":                      resourceTencentCloudAutoscalingAutoScalingGroup(),
			"tencentcloud_bi_embed_token":                                      resourceTencentCloudBiEmbedToken(),
			"tencentcloud_cam_role_permission_boundary":                        resourceTencentCloudCamRolePermissionBoundary(),
			"tencentcloud_cam_tag_role":                                        resourceTencentCloudCamTagRole(),
			"tencentcloud_cam_user_account_group":                              resourceTencentCloudCamUserAccountGroup(),
			"tencentcloud_cam_user_permission_boundary":                        resourceTencentCloudCamUserPermissionBoundary(),
			"tencentcloud_cam_set_policy_version":                              resourceTencentCloudCamSetPolicyVersion(),
			"tencentcloud_cat_task_ops":                                        resourceTencentCloudCatTaskOps(),
			"tencentcloud_cdb_accounts":                                        resourceTencentCloudCdbAccounts(),
			"tencentcloud_cdb_audit_log_file":                                  resourceTencentCloudCdbAuditLogFile(),
			"tencentcloud_cdb_backup_download_restriction":                     resourceTencentCloudCdbBackupDownloadRestriction(),
			"tencentcloud_cdb_backup_encryption_status":                        resourceTencentCloudCdbBackupEncryptionStatus(),
			"tencentcloud_cdb_db_import":                                       resourceTencentCloudCdbDbImport(),
			"tencentcloud_cdb_deploy_group":                                    resourceTencentCloudCdbDeployGroup(),
			"tencentcloud_cdb_instance_param":                                  resourceTencentCloudCdbInstanceParam(),
			"tencentcloud_cdb_instance_type":                                   resourceTencentCloudCdbInstanceType(),
			"tencentcloud_cdb_isolate_instance":                                resourceTencentCloudCdbIsolateInstance(),
			"tencentcloud_cdb_local_binlog_config":                             resourceTencentCloudCdbLocalBinlogConfig(),
			"tencentcloud_cdb_param_template":                                  resourceTencentCloudCdbParamTemplate(),
			"tencentcloud_cdb_password_complexity":                             resourceTencentCloudCdbPasswordComplexity(),
			"tencentcloud_cdb_remote_backup_config":                            resourceTencentCloudCdbRemoteBackupConfig(),
			"tencentcloud_cdb_ro_group":                                        resourceTencentCloudCdbRoGroup(),
			"tencentcloud_cdb_ro_replication":                                  resourceTencentCloudCdbRoReplication(),
			"tencentcloud_cdb_security_groups_attachment":                      resourceTencentCloudCdbSecurityGroupsAttachment(),
			"tencentcloud_cdb_switch_for_upgrade":                              resourceTencentCloudCdbSwitchForUpgrade(),
			"tencentcloud_cdb_time_window":                                     resourceTencentCloudCdbTimeWindow(),
			"tencentcloud_cfw_block_ignore_list":                               resourceTencentCloudCfwBlockIgnoreList(),
			"tencentcloud_cfw_natfw":                                           resourceTencentCloudCfwNatfw(),
			"tencentcloud_cfw_natpolicy":                                       resourceTencentCloudCfwNatpolicy(),
			"tencentcloud_ci_style":                                            resourceTencentCloudCiStyle(),
			"tencentcloud_ci_media_workflow":                                   resourceTencentCloudCiMediaWorkflow(),
			"tencentcloud_ci_poster_template":                                  resourceTencentCloudCiPosterTemplate(),
			"tencentcloud_clb_function_targets":                                resourceTencentCloudClbFunctionTargets(),
			"tencentcloud_cloudaudit_track":                                    resourceTencentCloudCloudauditTrack(),
			"tencentcloud_mongodb_instance_property":                           resourceTencentCloudMongodbInstanceProperty(),
			"tencentcloud_redis_backup":                                        resourceTencentCloudRedisBackup(),
			"tencentcloud_redis_modify_network_config":                         resourceTencentCloudRedisModifyNetworkConfig(),
			"tencentcloud_redis_upgrade":                                       resourceTencentCloudRedisUpgrade(),
			"tencentcloud_live_callback_rule":                                  resourceTencentCloudLiveCallbackRule(),
			"tencentcloud_live_callback_template":                              resourceTencentCloudLiveCallbackTemplate(),
			"tencentcloud_live_domain":                                         resourceTencentCloudLiveDomain(),
			"tencentcloud_live_common_mix_stream":                              resourceTencentCloudLiveCommonMixStream(),
			"tencentcloud_live_domain_cert":                                    resourceTencentCloudLiveDomainCert(),
			"tencentcloud_live_domain_cert_bindings":                           resourceTencentCloudLiveDomainCertBindings(),
			"tencentcloud_live_domain_referer":                                 resourceTencentCloudLiveDomainReferer(),
			"tencentcloud_live_play_auth_key":                                  resourceTencentCloudLivePlayAuthKey(),
			"tencentcloud_live_play_domain":                                    resourceTencentCloudLivePlayDomain(),
			"tencentcloud_live_push_auth_key":                                  resourceTencentCloudLivePushAuthKey(),
			"tencentcloud_live_record_rule":                                    resourceTencentCloudLiveRecordRule(),
			"tencentcloud_live_record_template":                                resourceTencentCloudLiveRecordTemplate(),
			"tencentcloud_live_snapshot_rule":                                  resourceTencentCloudLiveSnapshotRule(),
			"tencentcloud_live_snapshot_template":                              resourceTencentCloudLiveSnapshotTemplate(),
			"tencentcloud_css_live_transcode_rule":                             resourceTencentCloudCssLiveTranscodeRule(),
			"tencentcloud_live_stream_monitor":                                 resourceTencentCloudLiveStreamMonitor(),
			"tencentcloud_live_pad_rule":                                       resourceTencentCloudLivePadRule(),
			"tencentcloud_live_pad_template":                                   resourceTencentCloudLivePadTemplate(),
			"tencentcloud_live_backup_stream":                                  resourceTencentCloudLiveBackupStream(),
			"tencentcloud_live_timeshift_rule":                                 resourceTencentCloudLiveTimeshiftRule(),
			"tencentcloud_live_timeshift_template":                             resourceTencentCloudLiveTimeshiftTemplate(),
			"tencentcloud_css_watermark_rule":                                  resourceTencentCloudCssWatermarkRule(),
			"tencentcloud_cvm_chc_assist_vpc":                                  resourceTencentCloudCvmChcAssistVpc(),
			"tencentcloud_cvm_chc_deploy_vpc":                                  resourceTencentCloudCvmChcDeployVpc(),
			"tencentcloud_cwp_license_operation":                               resourceTencentCloudCwpLicenseOperation(),
			"tencentcloud_cynosdb_instances":                                   resourceTencentCloudCynosdbInstances(),
			"tencentcloud_cynosdb_backup":                                      resourceTencentCloudCynosdbBackup(),
			"tencentcloud_cynosdb_backup_config":                               resourceTencentCloudCynosdbBackupConfig(),
			"tencentcloud_cynosdb_cluster_resource_packages":                   resourceTencentCloudCynosdbClusterResourcePackages(),
			"tencentcloud_cynosdb_proxy_rw_split":                              resourceTencentCloudCynosdbProxyRwSplit(),
			"tencentcloud_vpc_dc_gateway_attachment":                           resourceTencentCloudVpcDcGatewayAttachment(),
			"tencentcloud_dc_dcx_extra_config":                                 resourceTencentCloudDcDcxExtraConfig(),
			"tencentcloud_dcdb_encrypt_attributes":                             resourceTencentCloudDcdbEncryptAttributes(),
			"tencentcloud_dts_compare_task_operate":                            resourceTencentCloudDtsCompareTaskOperate(),
			"tencentcloud_dts_migrate_check_job":                               resourceTencentCloudDtsMigrateCheckJob(),
			"tencentcloud_dts_migrate_instance":                                resourceTencentCloudDtsMigrateInstance(),
			"tencentcloud_dts_migrate_job_operate":                             resourceTencentCloudDtsMigrateJobOperate(),
			"tencentcloud_dts_sync_check_job":                                  resourceTencentCloudDtsSyncCheckJob(),
			"tencentcloud_dts_sync_job_operate":                                resourceTencentCloudDtsSyncJobOperate(),
			"tencentcloud_vpc_ipv6_address":                                    resourceTencentCloudVpcIpv6Address(),
			"tencentcloud_kms_cloud_resource":                                  resourceTencentCloudKmsCloudResource(),
			"tencentcloud_lighthouse_instance_login_key_pair":                  resourceTencentCloudLighthouseInstanceLoginKeyPair(),
			"tencentcloud_lighthouse_instance_modify_bundle":                   resourceTencentCloudLighthouseInstanceModifyBundle(),
			"tencentcloud_monitor_dns_config":                                  resourceTencentCloudMonitorDnsConfig(),
			"tencentcloud_monitor_grafana_env":                                 resourceTencentCloudMonitorGrafanaEnv(),
			"tencentcloud_monitor_grafana_whitelist":                           resourceTencentCloudMonitorGrafanaWhitelist(),
			"tencentcloud_monitor_sso_account":                                 resourceTencentCloudMonitorSsoAccount(),
			"tencentcloud_tke_tmp_alert_policy":                                resourceTencentCloudTkeTmpAlertPolicy(),
			"tencentcloud_mps_schedule_config":                                 resourceTencentCloudMpsScheduleConfig(),
			"tencentcloud_mps_workflow_config":                                 resourceTencentCloudMpsWorkflowConfig(),
			"tencentcloud_organization_org_member_auth_identity":               resourceTencentCloudOrganizationOrgMemberAuthIdentity(),
			"tencentcloud_organization_organization":                           resourceTencentCloudOrganizationOrganization(),
			"tencentcloud_organization_org_member_policy":                      resourceTencentCloudOrganizationOrgMemberPolicy(),
			"tencentcloud_postgres_network_access":                             resourceTencentCloudPostgresNetworkAccess(),
			"tencentcloud_postgres_read_only_group":                            resourceTencentCloudPostgresReadOnlyGroup(),
			"tencentcloud_postgres_d_b_instance_security_group":                resourceTencentCloudPostgresDBInstanceSecurityGroup(),
			"tencentcloud_postgres_backup_download_restriction_config":         resourceTencentCloudPostgresBackupDownloadRestrictionConfig(),
			"tencentcloud_postgres_backup_plan":                                resourceTencentCloudPostgresBackupPlan(),
			"tencentcloud_postgres_base_backup":                                resourceTencentCloudPostgresBaseBackup(),
			"tencentcloud_postgres_d_b_instance":                               resourceTencentCloudPostgresDBInstance(),
			"tencentcloud_postgres_parameter_template":                         resourceTencentCloudPostgresParameterTemplate(),
			"tencentcloud_privatedns_private_zone_vpc":                         resourceTencentCloudPrivatednsPrivateZoneVpc(),
			...
			"tencentcloud_ses_receiver_detail":                                 resourceTencentCloudSesReceiverDetail(),
			"tencentcloud_ses_smtp_pwd":                                        resourceTencentCloudSesSmtp_pwd(),
			"tencentcloud_sqlserver_database_t_d_e":                            resourceTencentCloudSqlserverDatabaseTDE(),
			"tencentcloud_sqlserver_config_database_c_d_c":                     resourceTencentCloudSqlserverConfigDatabaseCDC(),
			"tencentcloud_sqlserver_config_database_c_t":                       resourceTencentCloudSqlserverConfigDatabaseCT(),
			"tencentcloud_sqlserver_config_instance_network":                   resourceTencentCloudSqlserverConfigInstanceNetwork(),
			"tencentcloud_sqlserver_instance_t_d_e":                            resourceTencentCloudSqlserverInstanceTDE(),
			"tencentcloud_sqlserver_renew_d_b_instance":                        resourceTencentCloudSqlserverRenewDBInstance(),
			"tencentcloud_sqlserver_renew_postpaid_d_b_instance":               resourceTencentCloudSqlserverRenewPostpaidDBInstance(),
			"tencentcloud_sqlserver_restart_d_b_instance":                      resourceTencentCloudSqlserverRestartDBInstance(),
			"tencentcloud_sqlserver_config_terminate_d_b_instance":             resourceTencentCloudSqlserverConfigTerminateDBInstance(),
			"tencentcloud_sqlserver_general_backups":                           resourceTencentCloudSqlserverGeneralBackups(),
			"tencentcloud_tag_resource_tag":                                    resourceTencentCloudTagResourceTag(),
			"tencentcloud_tag_tag":                                             resourceTencentCloudTagTag(),
			"tencentcloud_tdmq_queue":                                          resourceTencentCloudTdmqQueue(),
			"tencentcloud_tdmq_subscribe":                                      resourceTencentCloudTdmqSubscribe(),
			"tencentcloud_tcr_immutable_tag_rules":                             resourceTencentCloudTcrImmutableTagRules(),
			"tencentcloud_tdmqRocketmq_cluster":                                resourceTencentCloudTdmqRocketmqCluster(),
			"tencentcloud_tdmqRocketmq_environment_role":                       resourceTencentCloudTdmqRocketmqEnvironmentRole(),
			"tencentcloud_tdmqRocketmq_group":                                  resourceTencentCloudTdmqRocketmqGroup(),
			"tencentcloud_tdmqRocketmq_namespace":                              resourceTencentCloudTdmqRocketmqNamespace(),
			"tencentcloud_tdmqRocketmq_role":                                   resourceTencentCloudTdmqRocketmqRole(),
			"tencentcloud_tdmqRocketmq_topic":                                  resourceTencentCloudTdmqRocketmqTopic(),
			...
			"tencentcloud_teo_certificate":                                     resourceTencentCloudTeoCertificate(),
			"tencentcloud_tse_update_group_spec":                               resourceTencentCloudTseUpdateGroupSpec(),
			"tencentcloud_tse_cngw_route_limit":                                resourceTencentCloudTseCngwRouteLimit(),
			"tencentcloud_tse_cngw_service_limit":                              resourceTencentCloudTseCngwServiceLimit(),
			"tencentcloud_tsf_applicationfile_config_release":                  resourceTencentCloudTsfApplicationfileConfigRelease(),
			"tencentcloud_tsf_application_public_config_attachment":            resourceTencentCloudTsfApplicationPublicConfigAttachment(),
			"tencentcloud_tsf_contain_group":                                   resourceTencentCloudTsfContainGroup(),
			"tencentcloud_tsf_deploy_v_m_group":                                resourceTencentCloudTsfDeployVMGroup(),
			"tencentcloud_tsf_start_container_group":                           resourceTencentCloudTsfStartContainerGroup(),
			"tencentcloud_tsf_stop_group":                                      resourceTencentCloudTsfStopGroup(),
			"tencentcloud_vpc_vpn_gateway_ssl_client_cert":                     resourceTencentCloudVpcVpnGatewaySslClientCert(),
			"tencentcloud_waf_instance":                                        resourceTencentCloudWafInstance(),
			"tencentcloud_wedata_dq_rule_template":                             resourceTencentCloudWedataDq_ruleTemplate(),
			"tencentcloud_wedata_baseline_baseline":                            resourceTencentCloudWedataBaseline_baseline(),
			"tencentcloud_wedata_datasource":                                   resourceTencentCloudWedataDatasource(),
			"tencentcloud_wedata_integration_offline_task":                     resourceTencentCloudWedataIntegration_offline_task(),
			"tencentcloud_wedata_integration_real_time_task":                   resourceTencentCloudWedataIntegration_real_time_task(),
			"tencentcloud_wedata_integration_task_node":                        resourceTencentCloudWedataIntegration_task_node(),
		},
