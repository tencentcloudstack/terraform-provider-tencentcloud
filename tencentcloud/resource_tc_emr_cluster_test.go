		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testTkeClusterResourceKey, "vpc_settings.vpc_id", "vpc-fuwly8x5"),
					resource.TestCheckResourceAttr(testTkeClusterResourceKey, "vpc_settings.subnet_id", "subnet-d830wfso"),
					resource.TestCheckResourceAttr(testTkeClusterResourceKey, "softwares.0", "hadoop-2.8.4"),
					resource.TestCheckResourceAttr(testTkeClusterResourceKey, "softwares.1", "zookeeper-3.4.9"),
					...
					resource.TestCheckResourceAttr(testTkeClusterResourceKey, "time_span", "1"),
					resource.TestCheckResourceAttr(testTkeClusterResourceKey, "time_unit", "m"),
					resource.TestCheckResourceAttr(testTkeClusterResourceKey, "pay_mode", "1"),
