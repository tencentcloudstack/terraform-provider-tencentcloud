		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("tencentcloud_sqlserver_database_tde.example", "id"),
				),
			},
			{
...
const testAccSqlserverDatabaseTDE = defaultVpcSubnets + defaultSecurityGroupData + `
...
const testAccSqlserverDatabaseTDEUpdate = defaultVpcSubnets + defaultSecurityGroupData + `
data "tencentcloud_availability_zones_by_product" "zones" {
  product = "sqlserver"
}
