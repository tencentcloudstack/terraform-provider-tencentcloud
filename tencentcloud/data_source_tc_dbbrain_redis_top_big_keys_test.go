		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTencentCloudDataSourceID("data.tencentcloud_dbbrain_redis_top_big_keys.redis_top_big_keys"),
...
const testAccDbbrainRedisTopBigKeysDataSource = CommonPresetRedis + `
