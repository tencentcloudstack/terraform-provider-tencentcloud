...
func TkeCvmCreateInfo() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"instance_charge_type": {
			...
			Description:  "The charge type of instance. Valid values are `PREPAID` and `POSTPAID_BY_HOUR`, The default is `POSTPAID_BY_HOUR`. Note: international account only supports PREPAID.",
		},
