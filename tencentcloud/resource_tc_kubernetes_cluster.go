...
func TkeCvmCreateInfo() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"instance_charge_type": {
			...
			ValidateFunc: validateAllowedStringValue(TKE_WORKER_CHARGE_TYPE),
			Description:  "The charge type of instance. Valid values are `PREPAID` and `POSTPAID_BY_HOUR`, The default is `POSTPAID_BY_HOUR`.",
		},
