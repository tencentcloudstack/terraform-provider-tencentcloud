		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testDataPostgresqlInstancesName, "instance_list.#.engine_version", "9.3.5"),
					resource.TestCheckResourceAttr(testDataPostgresqlInstancesName, "instance_list.#.project_id", "0"),
					resource.TestCheckResourceAttr(testDataPostgresqlInstancesName, "instance_list.#.mem_size", "2"),
					resource.TestCheckResourceAttr(testDataPostgresqlInstancesName, "instance_list.#.volume_size", "1"),
				),
			},
		},
	})
