	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"status": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "HTTP protocol response code.",
			},

			"ret": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "Remote request response body code.",
			},

			"net_status": {
				Optional:    true,
				Type:        schema.TypeString,
				Description: "The network status where the data reporting takes place.`0`: &amp;amp;#39;noraml&amp;amp;#39;, `1`: &amp;amp;#39;week&amp;amp;#39;, `2`: &amp;amp;#39;disconnection&amp;amp;#39;, `3`: &amp;amp;#39;unknown&amp;amp;#39; .",
			},
...
func dataSourceTencentCloudRumFetchUrlRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloud_rum_fetch_url.read")()
	...
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
		result, e := service.DescribeRumFetchUrlByFilter(ctx, paramMap)
		if e != nil {
			return retryError(e)
		}
		result = result
